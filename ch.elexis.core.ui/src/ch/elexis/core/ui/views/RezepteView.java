...
public class RezepteView extends ViewPart implements IActivationListener,
	...
	private final ElexisEventListener eeli_rp = new ElexisUiEventListenerImpl(
	...
	private void makeActions() {
		...
		addLineAction.setImageDescriptor(Images.IMG_ADDITEM
				.getImageDescriptor());
		printAction.setImageDescriptor(Images.IMG_PRINTER.getImageDescriptor());
		deleteRpAction.setImageDescriptor(Images.IMG_DELETE
				.getImageDescriptor());
	}
