...
public class BezugsKontaktAuswahl extends Dialog {
	...
	public void create(){
		super.create();
		getShell().setText(ch.elexis.core.ui.views.Messages.getString("Patientenblatt2.kindOfRelation")); //$NON-NLS-1$
	}
	
	@Override
	protected Control createDialogArea(Composite parent){
		Composite ret = (Composite) super.createDialogArea(parent);
		new Label(ret, SWT.NONE).setText(ch.elexis.core.ui.views.Messages
