...
public class ToggleCurrentKonsultationLockHandler extends AbstractHandler implements IElementUpdater {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		IPersistentObject po = ElexisEventDispatcher.getSelected(Konsultation.class);
		if (po == null) {
