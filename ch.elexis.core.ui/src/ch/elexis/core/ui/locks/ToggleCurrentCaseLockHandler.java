...
public class ToggleCurrentCaseLockHandler extends AbstractHandler implements IElementUpdater {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException{
		...
		IPersistentObject po = ElexisEventDispatcher.getSelected(Fall.class);
		if (po == null) {
