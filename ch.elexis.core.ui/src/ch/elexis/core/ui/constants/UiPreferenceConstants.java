...
/**
 * This class provides preference constants to be referenced by the UI parts requiring configuration values.
 * 
 * @since 3.0.0
 */
public class UiPreferenceConstants {
	...
	public static final String USERSETTINGS2_EXPANDABLE_COMPOSITES = USERSETTINGS2_EXPANDABLE_COMPOSITES_BASE + "/setting"; 
	public static final String USERSETTINGS2_EXPANDABLE_COMPOSITES_STATES = USERSETTINGS2_EXPANDABLE_COMPOSITES_BASE + "/states/"; 
