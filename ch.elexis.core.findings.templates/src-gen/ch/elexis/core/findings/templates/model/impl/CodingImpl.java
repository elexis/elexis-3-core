 ...
 * </p>
 * <ul>
 *   <li>{@link ch.elexis.core.findings.templates.model.impl.CodingImpl#getSystem <em>System</em>}</li>
 *   <li>{@link ch.elexis.core.findings.templates.model.impl.CodingImpl#getCode <em>Code</em>}</li>
 *   <li>{@link ch.elexis.core.findings.templates.model.impl.CodingImpl#getDisplay <em>Display</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CodingImpl extends MinimalEObjectImpl.Container implements Coding {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.CODING;
	}
	...
	public void setSystem(String newSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CODING__SYSTEM, oldSystem, system));
	}
	...
	public void setCode(String newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CODING__CODE, oldCode, code));
	}
	...
	public void setDisplay(String newDisplay) {
		...
		display = newDisplay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CODING__DISPLAY, oldDisplay, display));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.CODING__SYSTEM:
				return getSystem();
			case ModelPackage.CODING__CODE:
				return getCode();
			case ModelPackage.CODING__DISPLAY:
				return getDisplay();
		}
