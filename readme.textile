...
You need Java 1.7.5. Maven (we use 3.0.4 for our builds, other versions might work). Then you should be able to generate the application and p2 update site using the following calls:
