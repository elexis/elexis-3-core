...
public class BillingSystemFactorTest extends AbstractTest {
	...
	public void create() {
		...
		Optional<IBillingSystemFactor> loadedFactor = coreModelService.load(factor.getId(), IBillingSystemFactor.class);
	...
	public void query() {
		...
		query.and(ModelPackage.Literals.IBILLING_SYSTEM_FACTOR__SYSTEM, COMPARATOR.EQUALS, "testsystem");
		...
		query.and(ModelPackage.Literals.IBILLING_SYSTEM_FACTOR__SYSTEM, COMPARATOR.EQUALS, "testsystem");
		query.and(ModelPackage.Literals.IBILLING_SYSTEM_FACTOR__VALID_TO, COMPARATOR.GREATER_OR_EQUAL,
