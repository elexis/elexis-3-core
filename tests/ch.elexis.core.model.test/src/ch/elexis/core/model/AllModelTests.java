...
@SuiteClasses({ IdentifiableTest.class, AccountTransactionTest.class, AppointmentTest.class, ConfigTest.class,
		...
		ArticleTest.class, UserConfigTest.class, XidTest.class, BillingSystemFactorTest.class, LocalServiceTest.class,
		...
		TextTemplateTest.class, SickCertificateTest.class, InvoiceTest.class, DayMessageTest.class, BlobTest.class })
