...
public class UserServiceTest extends AbstractServiceTest {
	...
	public void getUsersByAssociatedContact() {
		...
		assertNotNull(user);
		IContact assocatiedContact = coreModelService.load("h2c1172107ce2df95065", IContact.class).orElse(null);
		assertNotNull(assocatiedContact);

		List<IUser> usersByAssociatedContact = service.getUsersByAssociatedContact(assocatiedContact);
