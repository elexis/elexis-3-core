...
public class VirtualFileHandle_Combined_Test extends AbstractVirtualFileHandleTest {
	...
	private List<String> FILENAMES_TO_TEST = Arrays.asList(
			...
			"[Schopl Rbdssea 3 #178151]-Coloskopie_19100224.pdf", "[Schopl Rbdssea 3 178151]-Coloskopie_19100224.pdf",
			"2021-03-15-11-43-59-1.pdf", "[#75503]-Bericht Dr.BELLI 1.3.21-1.pdf",
	...
	public void copyFromFileToSmb() throws IOException {
		...
		IVirtualFilesystemHandle remoteSubDir = service.of(PREFIX_AUTH_SAMBA).subDir("combined-test");
