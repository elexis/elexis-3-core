...
public class JCifsTest {
	...
	// public static final String PREFIX_NOAUTH_WIN2KSRV =
	// "smb://win2k12srv.medelexis.ch/smb_for_unittests/";
	// bug see https://github.com/AgNO3/jcifs-ng/issues/105

	public static String PREFIX_AUTH_SAMBA = "smb://unittest:unittest@gitlab.medelexis.ch/tests/";
	public static String PREFIX_AUTH_WIN2KSRV = "smb://unittest:Unit_Test_17@win2k12srv.medelexis.ch/smb_for_unittests/";
	...
	public static Iterable<String> data() {
		...
		if (nonDefaultServer.isEmpty() && !nonDefaultServer.contentEquals("true")) {
			...
			skipTest = true;
			return Arrays.asList(new String[]{PREFIX_NOAUTH_SAMBA});
		}
		if (!nonDefaultServer.contentEquals("true")) {
			...
			PREFIX_AUTH_WIN2KSRV = "smb://unittest:Unit_Test_17@win2k12srv." + server + "/smb_for_unittests/";
		} else {
			server = "gitlab.medelexis.ch"; // default
		}
		return Arrays.asList(new String[]{PREFIX_NOAUTH_SAMBA, PREFIX_AUTH_SAMBA, PREFIX_AUTH_WIN2KSRV});
	}
