...
public class Test_Verrechnet extends AbstractPersistentObjectTest {
	...
	public void createAndEscapeChars() {
		Artikel art = new Artikel("Vorsorgeuntersuchungen gemäss Empfehlungen {SGP}'93, im 1. Monat",
		...
		assertEquals("Vorsorgeuntersuchungen gemäss Empfehlungen {SGP}'93, im 1. Monat", vr.getText());
	}
}
