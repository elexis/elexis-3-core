...
@SuiteClasses({ Test_DBInitialState.class, Test_PersistentObject.class, Test_Prescription.class, Test_Patient.class,
		...
		Test_StockService.class, Test_OrderService.class, Test_Konsultation.class, Test_VkPreise.class,
		Test_ZusatzAdresse.class, Test_Rechnung.class, Test_Trace.class, Test_User.class, Test_LabResult.class,
		Test_BezugsKontakt.class })
