...
public class Test_LabResult {
	...
	public static void prepareLabItems() {
		...
		absoluteLabItem = new LabItem("kuerzel1", "testname1", org, REFVAL, REFVAL, "", LabItemTyp.ABSOLUTE, "gruppe",
				"0");
		textLabItem = new LabItem("kuerzel2", "testname2", org, REFVAL, REFVAL, "", LabItemTyp.ABSOLUTE, "gruppe", "0");
	}
	...
	public void testCreateLabResultAssertLabOrder() {
		LabResult labResult = LabResult.createLabResultAndAssertLabOrder(patient, new TimeTool(), absoluteLabItem,
				REFVAL, "", null, REFVAL, null, "orderId", null, null, "testGroup");
