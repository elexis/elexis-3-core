...
public class PersistentObjectImpl extends PersistentObject {
	...
	private static final String create = "CREATE TABLE " + TABLENAME + " (" + "ID VARCHAR(25) primary key, "
			+ "lastupdate BIGINT," + "deleted CHAR(1) default '0'," + FLD_TEST + " VARCHAR(255) );";
	...
	static {
		addMapping(TABLENAME, FLD_TEST, FLD_JOINT_OTHER + "=JOINT:PersistentObjectId:OtherId:PO_OTHER_JOINT",
