...
public class FamilyMemberHistoryTest {
	...
	public void manyFamilyMemberHistories() {
		...
		for (int i = 0; i < 1000; i++) {
			IFamilyMemberHistory familyMemberHistory = FindingsServiceComponent.getService()
					.create(IFamilyMemberHistory.class);
		...
		List<IFamilyMemberHistory> findings = FindingsServiceComponent.getService()
				.getPatientsFindings(AllTests.PATIENT_ID, IFamilyMemberHistory.class);
