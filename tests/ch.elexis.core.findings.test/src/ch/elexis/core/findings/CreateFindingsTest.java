...
public class CreateFindingsTest {
	...
	public void createEncounter() {
		...
		assertEquals(AllTests.CONSULTATION_ID, ((IEncounter) encounters.get(0)).getConsultationId());
	}
	...
	public void createClinicalImpression() {
		...
		encounter.setPatientId(AllTests.PATIENT_ID);
		FindingsServiceComponent.getService().saveFinding(encounter);
		IClinicalImpression clinicalImpression = FindingsServiceComponent.getService()
				.create(IClinicalImpression.class);
