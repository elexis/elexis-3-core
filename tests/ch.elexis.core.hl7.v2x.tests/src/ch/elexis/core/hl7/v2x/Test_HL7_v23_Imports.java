...
public class Test_HL7_v23_Imports {
	...
	private File[] loadv23Files() {
		File directory = new File(PlatformHelper.getBasePath("ch.elexis.core.hl7.v2x.tests"), "rsc/v23");
