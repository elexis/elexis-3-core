...
public class PasswordValidatorTest {
	...
	public void testCases() {
		...
		assertEquals(
				new HashSet<PasswordValidationResult>(Arrays.asList(PasswordValidationResult.MISSING_NUMBER,
		...
		assertEquals(Collections.singleton(PasswordValidationResult.EXCLUDED_PASSWORD),
				PasswordValidator.validateNewPass("aA1bCdd", "aA1bCdd", new HashSet<String>(Arrays.asList("aA1bCdd"))));
	}
