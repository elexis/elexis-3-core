...
public abstract class ZonedDateTimeMatchers {
	 ...
	 * @param nanos
	 *            the nanos of the second
	 */
	public static Matcher<ZonedDateTime> after(final int year, final Month month, final int dayOfMonth, final int hour,
			final int minute, final int second, final int nanos, final ZoneId tz) {
	...
	/**
	 * Creates a matcher that matches when the examined date is before the end of
	 * the reference year
	 * <p/>
	 * For example:
	 *
	 ...
	 *            the second of the minute
	 * @param nanos
	 *            the nanoseconds of the second
	 */
	public static Matcher<ZonedDateTime> before(final int year, final Month month, final int dayOfMonth, final int hour,
			final int minute, final int second, final int nanos, final ZoneId tz) {
	 ...
	 */
	public static Matcher<ZonedDateTime> isDay(final int year, final Month month, final int dayOfMonth,
			final ZoneId tz) {
	 ...
	 *            the timezone
	 */
	public static Matcher<ZonedDateTime> isInstant(final int year, final Month month, final int dayOfMonth,
			final int hour, final int minute, final int second, final int nanos, final ZoneId tz) {
	 ...
	 */
	@Factory
	public static Matcher<ZonedDateTime> sameOrBefore(final int year, final Month month, final int day, final int hour,
			final int minute, final int second, final int nanos, final ZoneId tz) {
	 ...
	 */
	@Factory
	public static Matcher<ZonedDateTime> sameOrAfter(final int year, final Month month, final int day, final int hour,
			final int minute, final int second, final int nanos, final ZoneId tz) {
	 ...
	 *            the second of the minute
	 * @param nanos
	 *            the nanonseconds of the second
	 * @param tz
	 *            the time zone of the reference date
	 */
	public static Matcher<ZonedDateTime> within(final long period, final ChronoUnit unit, final int year,
			final Month month, final int dayofMonth, final int hour, final int minute, final int second,
			final int nanos, final ZoneId tz) {
		return new IsWithin<ZonedDateTime>(period, unit,
				new ZonedDateTimeWrapper(year, month, dayofMonth, hour, minute, second, nanos, tz),
				new ZonedDateTimeFormatter());
	}
	...
	public static Matcher<ZonedDateTime> isFirstDayOfMonth() {
		return new IsMinimum<ZonedDateTime>(ChronoField.DAY_OF_MONTH, t -> t, new DatePartFormatter(),
	...
	public static Matcher<ZonedDateTime> isLastDayOfMonth() {
		return new IsMaximum<ZonedDateTime>(ChronoField.DAY_OF_MONTH, t -> t, new DatePartFormatter(),
	...
	/**
	 * Creates a matcher that matches when the examined date is on the expected hour
	 * (0-23)
	 * <p/>
	 * For example:
	 *
