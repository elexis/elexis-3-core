...
public abstract class LocalTimeMatchers {
	...
	/**
	 * Creates a matcher that matches when the examined time is after the reference
	 * time
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is after the end of the
	 * reference year
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is before the reference
	 * time
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is before the end of
	 * the reference year
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is at the same instant
	 * or before the reference time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same day or
	 * before the start of the reference time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same day or
	 * after the start of the reference time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined time is on the expected hour
	 * (0-23)
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same hour as
	 * the reference time
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same minute
	...
	/**
	 * Creates a matcher that matches when the examined time is on the same second
	 * as the reference time
	 * <p/>
	 * For example:
	 *
