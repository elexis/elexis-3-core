...
public abstract class DateMatchers {
	...
	/**
	 * Creates a matcher that matches when the examined date is after the reference
	 * date
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined date is after the end of the
	 * reference year
	 * <p/>
	 * For example:
	 *
	 ...
	 */
	@Deprecated
	public static Matcher<Date> after(final int year, final Months month, final int dayOfMonth, final int hour,
	 ...
	 *            checked
	 */
	public static Matcher<Date> after(final int year, final Month month, final int dayOfMonth, final int hour,
			final int minute, final int second) {
		return new IsAfter<Date>(new DateWrapper(year, month, dayOfMonth, hour, minute, second), new DateFormatter());
	}

	/**
	 * Creates a matcher that matches when the examined date is before the reference
	 * date
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined date is before the start of
	 * reference day
	 * <p/>
	 * For example:
	 *
	 ...
	 */
	@Deprecated
	public static Matcher<Date> before(final int year, final Months month, final int dayOfMonth, final int hour,
			final int minute, final int second) {
	 ...
	 *            checked
	 */
	public static Matcher<Date> before(final int year, final Month month, final int dayOfMonth, final int hour,
			final int minute, final int second) {
		return new IsBefore<Date>(new DateWrapper(year, month, dayOfMonth, hour, minute, second), new DateFormatter());
	}

	/**
	 * Creates a matcher that matches when the examined date is on the same day of
	 * the week as the reference date
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same day of
	 * the month as the reference date
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined date is on the expected day
	 * of the month
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same day of
	 * the year as the reference date
	 * <p/>
	 * For example:
	 *
	 * <pre>
	 ...
	 *
	 * @param day
	 *            the reference day of the month against which the examined date is
	 *            checked
	 * @param month
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same hour as
	 * the reference date
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same instance
	 * as the reference date
	 * <p/>
	 * For example:
	 *
	 ...
	 *            checked
	 * @param milliseconds
	 *            the milliseconds of the second against which the examined date is
	 *            checked
	 * @deprecated Use {@link #isInstant(int, Month, int, int, int, int, int)}
	 */
	@Deprecated
	public static Matcher<Date> sameInstant(final int year, final Months month, final int dayOfMonth, final int hour,
			final int minute, final int second, final int milliseconds) {
	 ...
	 *            checked
	 */
	public static Matcher<Date> isInstant(final int year, final Month month, final int dayOfMonth, final int hour,
			final int minute, final int second, final int milliseconds) {
	...
	/**
	 * Creates a matcher that matches when the examined date is at the same instant
	...
	/**
	 * Creates a matcher that matches when the examined date is at the same date or
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same day or
	 * before the start of the reference date
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same second
	 * or before the start of the reference date and time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	 ...
	 */
	@Deprecated
	public static Matcher<Date> sameOrBefore(final int year, final Months month, final int dayOfMonth, final int hour,
			final int minute, final int second) {
	...
	public static Matcher<Date> sameOrBefore(final int year, final Month month, final int dayOfMonth, final int hour,
			final int minute, final int second) {
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same day or
	 * after the start of the reference date
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same second
	 * or after the start of the reference date and time
	 * <p/>
	 * For example:
	 *
	 * <pre>
	 ...
	 */
	@Deprecated
	public static Matcher<Date> sameOrAfter(final int year, final Months month, final int dayOfMonth, final int hour,
			final int minute, final int second) {
	...
	public static Matcher<Date> sameOrAfter(final int year, final Month month, final int dayOfMonth, final int hour,
			final int minute, final int second) {
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same month as
	 * the reference date
	 * <p/>
	 * For example:
	 *
	...
	/**
	 * Creates a matcher that matches when the examined date is on the same year as
	 * the reference date
	 * <p/>
	 * For example:
	 *
	 ...
	 */
	@Deprecated
	public static Matcher<Date> within(final long period, final TimeUnit unit, final int year, final Months month,
	 ...
	 *            the day of the month against which the examined date is checked
	 */
	public static Matcher<Date> within(final long period, final ChronoUnit unit, final int year, final Month month,
			final int dayOfMonth) {
	 ...
	 *            checked
	 * @param second
	 *            the millisecond of the second against which the examined date is
	 *            checked
	 * @deprecated Use
	...
	@Deprecated
	public static Matcher<Date> within(final long period, final TimeUnit unit, final int year, final Months month,
			final int dayOfMonth, final int hour, final int minute, final int second, final int milliseconds) {
	...
	public static Matcher<Date> within(final long period, final ChronoUnit unit, final int year, final Month month,
			final int dayOfMonth, final int hour, final int minute, final int second, final int milliseconds) {
		return new IsWithin<Date>(period, unit,
				new DateWrapper(year, month, dayOfMonth, hour, minute, second, milliseconds), new DateFormatter());
	}
	...
	/**
	 * Creates a matcher that matches when the examined date is on the first day of
	 * the month
	 * <p/>
	 * For example:
	 *
	...
	public static Matcher<Date> isFirstDayOfMonth() {
		return new IsMinimum<Date>(ChronoField.DAY_OF_MONTH, DateMatchers::dateToZoneDateTime, new DatePartFormatter(),
				() -> "the date is the first day of the month");
	}

	/**
	 * Creates a matcher that matches when the examined date is on the maximum value
	 * of the given date part in its period
	 * <p/>
	 * For example:
	 *
	 * <pre>
	...
	public static Matcher<Date> isLastDayOfMonth() {
		return new IsMaximum<Date>(ChronoField.DAY_OF_MONTH, DateMatchers::dateToZoneDateTime, new DatePartFormatter(),
