...
public class LaborResultsComposite extends Composite {
	...
	private static class LaborResultsContentProvider implements ITreeContentProvider {
		...
		public void inputChanged(Viewer viewer, Object oldInput, Object newInput){
			if (newInput instanceof HashMap<?, ?>) {
				grouped =
					(HashMap<String, HashMap<String, HashMap<String, List<LabResult>>>>) newInput;
				updateItemResults();
			}
		}
	...
	private static class LaborItemResults implements Comparable<LaborItemResults> {
