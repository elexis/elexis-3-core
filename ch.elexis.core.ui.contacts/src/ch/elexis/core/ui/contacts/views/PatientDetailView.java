...
public class PatientDetailView extends ViewPart {
	...
	public void createPartControl(Composite parent){
		...
		// diagnosis
		{
			...
			sectDiagnosen.setExpanded(CoreHub.localCfg.get(
		...
		// family anamnesis
		{
			...
			sectFamAnamnese.setExpanded(CoreHub.localCfg.get(
		...
		// allergy
		{
			...
			sectAllergien.setExpanded(CoreHub.localCfg.get(
		...
		// remarks
		{
			...
			sectBemerkungen.setExpanded(CoreHub.localCfg.get(
