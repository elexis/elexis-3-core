...
public class KontakteView extends ViewPart implements ControlFieldListener, ISaveablePart2 {
	...
	private final String[] fields = {
		Kontakt.FLD_SHORT_LABEL + Query.EQUALS + Messages.KontakteView_shortLabel, //$NON-NLS-1$
				...
				try {
					...
					ElexisStatus es =
						new ElexisStatus(ElexisStatus.ERROR, Activator.PLUGIN_ID,
							ElexisStatus.CODE_NONE, "Fehler beim Öffnen", e);
	...
	private void makeActions(){
		delKontakt =
			new RestrictedAction(AccessControlDefaults.KONTAKT_DELETE, Messages.KontakteView_delete) { //$NON-NLS-1$
				@Override
				public void doRun(){
