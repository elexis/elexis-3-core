...
# 
# The config file was generated by setting a project to use 3lexisFormatterProfile.xml
# which was found inside the root directory of the https://github.com/elexis/elexis-3-core.git 
# repositories
# Then it is found in the project under .settings.
#

Profile = %(
# inline. Look for #{__FILE__} inside https://github.com/elexis/elexis-3-core.git
