...
* @cd ch.elexis.core.releng/elexis.3rdpart.libraries && mvn clean p2:site@ # Builds a p2-site needed to use Eclipse target definition ch.elexis.core.releng/elexis-3.target
