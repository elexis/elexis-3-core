...
find . -name "feature.xml" -type f -exec sed -i '' 's/version="3.13.0.qualifier"/version="3.14.0.qualifier"/g' {} +
find . -name "MANIFEST.MF" -type f -exec sed -i '' 's/Bundle-Version: 3.13.0.qualifier/Bundle-Version: 3.14.0.qualifier/g' {} +
find . -name "pom.xml" -type f -exec sed -i '' 's/<version>3.13.0-SNAPSHOT<\/version>/<version>3.14.0-SNAPSHOT<\/version>/g' {} +
...
find . -name "MANIFEST.MF" -type f -exec sed -i '' 's/ch.elexis.core.ui;bundle-version="3.13.0"/ch.elexis.core.ui;bundle-version="3.14.0"/g' {} +

find . -name "MANIFEST.MF" -type f -exec sed -i '' 's/ch.elexis.core;bundle-version="3.13.0"/ch.elexis.core;bundle-version="3.14.0"/g' {} +

find . -name "MANIFEST.MF" -type f -exec sed -i '' 's/ch.elexis.core.data;bundle-version="3.13.0"/ch.elexis.core.data;bundle-version="3.14.0"/g' {} +

find . -name "MANIFEST.MF" -type f -exec sed -i '' 's/ch.elexis.core.ui.e4;bundle-version="3.13.0"/ch.elexis.core.ui.e4;bundle-version="3.14.0"/g' {} +