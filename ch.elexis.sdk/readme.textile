...
# the first time you use the installer you have to provide some additional information, please be careful to select the correct github username and/or access type, otherwise the installationw will fail. <br> !images/oomphConfiguration.png!
