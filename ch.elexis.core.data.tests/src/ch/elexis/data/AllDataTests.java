...
@SuiteClasses({ Test_DBInitialState.class, Test_PersistentObject.class, Test_Prescription.class, Test_Patient.class,
		Test_LabItem.class, Test_DBImage.class, Test_Query.class, Test_Verrechnet.class,
...
public class AllDataTests {
	...
	static {
		...
		AllDataTests.connections.add(new Object[] { h2JdbcLink });
		if (mySQLJdbcLink != null) {
			AllDataTests.connections.add(new Object[] { mySQLJdbcLink });
		}
		if (pgJdbcLink != null) {
			AllDataTests.connections.add(new Object[] { pgJdbcLink });
		}
	}
	...
	public static void afterClass() {
		for (Object[] objects : AllDataTests.connections) {
			...
			try {
				...
				// exception is allowed for tests which get rid of the
