...
import ch.elexis.data.views.Test_InvoiceBillState;
...
@SuiteClasses({
	...
	Test_ZusatzAdresse.class, BriefDocumentStoreTest.class, Test_Rechnung.class, Test_InvoiceBillState.class
})
