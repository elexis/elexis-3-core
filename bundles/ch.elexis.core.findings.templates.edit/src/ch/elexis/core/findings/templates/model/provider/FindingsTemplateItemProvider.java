 ...
 * {@link ch.elexis.core.findings.templates.model.FindingsTemplate} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class FindingsTemplateItemProvider extends ItemProviderAdapter
		implements
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_FindingsTemplate_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_FindingsTemplate_type_feature",
								"_UI_FindingsTemplate_type"),
						ModelPackage.Literals.FINDINGS_TEMPLATE__TYPE, true, false, false,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_FindingsTemplate_title_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_FindingsTemplate_title_feature",
								"_UI_FindingsTemplate_type"),
						ModelPackage.Literals.FINDINGS_TEMPLATE__TITLE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addCodeElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_FindingsTemplate_codeElement_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_FindingsTemplate_codeElement_feature",
								"_UI_FindingsTemplate_type"),
						ModelPackage.Literals.FINDINGS_TEMPLATE__CODE_ELEMENT, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ModelPackage.Literals.FINDINGS_TEMPLATE__INPUT_DATA,
