...
public class ModelItemProviderAdapterFactory extends ModelAdapterFactory
	 ...
	 * {@link ch.elexis.core.findings.templates.model.FindingsTemplates} instances.
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link ch.elexis.core.findings.templates.model.FindingsTemplate} instances.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link ch.elexis.core.findings.templates.model.InputDataNumeric} instances.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a
	 * {@link ch.elexis.core.findings.templates.model.InputDataNumeric}. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link ch.elexis.core.findings.templates.model.InputDataText} instances. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a
	 * {@link ch.elexis.core.findings.templates.model.InputDataText}. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link ch.elexis.core.findings.templates.model.InputDataGroup} instances.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a
	 * {@link ch.elexis.core.findings.templates.model.InputDataGroup}. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link ch.elexis.core.findings.templates.model.CodeElement} instances. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a
	 * {@link ch.elexis.core.findings.templates.model.CodeElement}. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	public void dispose() {
		...
		if (findingsTemplateItemProvider != null)
			findingsTemplateItemProvider.dispose();
		if (inputDataNumericItemProvider != null)
			inputDataNumericItemProvider.dispose();
		if (inputDataTextItemProvider != null)
			inputDataTextItemProvider.dispose();
		if (inputDataGroupItemProvider != null)
			inputDataGroupItemProvider.dispose();
		if (inputDataGroupComponentItemProvider != null)
			inputDataGroupComponentItemProvider.dispose();
		if (codeElementItemProvider != null)
			codeElementItemProvider.dispose();
	}
