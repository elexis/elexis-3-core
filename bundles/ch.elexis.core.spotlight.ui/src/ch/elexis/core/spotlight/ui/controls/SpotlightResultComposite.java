...
public class SpotlightResultComposite extends Composite {
	...
	public SpotlightResultComposite(Composite parent, int style, ISpotlightService spotlightService,
			SpotlightUiUtil uiUtil, ISpotlightResultEntryDetailCompositeService resultEntryDetailCompositeService) {
		super(parent, style);
		...
		resultDetailComposite = new SpotlightResultDetailComposite(this, style, resultEntryDetailCompositeService);
