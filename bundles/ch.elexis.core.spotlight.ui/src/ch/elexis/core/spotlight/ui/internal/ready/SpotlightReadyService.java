...
public class SpotlightReadyService {
	...
	public void activate() {
		...
		contextService.getRootContext().setNamed(PATIENT_SELECTION_HISTORY, patientSelectionHistorySupplier);
	...
	/**
	 * @return the last 5 selected patients in format [patient id, String (selection
	 *         time), String (patient label)]
	 */
	@SuppressWarnings("unchecked")
	public List<Object[]> getLastPatientSelections() {
		return (List<Object[]>) contextService.getRootContext().getNamed(PATIENT_SELECTION_HISTORY).get();
	}
