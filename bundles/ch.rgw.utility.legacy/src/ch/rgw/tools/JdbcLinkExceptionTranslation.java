 ...
 * <li>{@link JdbcLinkResourceException} for connection problems, or resource
 * problems on the database</li>
 * <li>{@link JdbcLinkSyntaxException} for problems with the syntax of the SQL
 * statement</li>
 * <li>{@link JdbcLinkConcurrencyException} for problems with concurrent
 * access</li>
 * </p>
 * <p>
 * Translation Sets based on the SQLStateSQLExceptionTranslator class of the
 * spring framework.
 * </p>
 *
 * @author thomas
