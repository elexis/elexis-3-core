...
/**
 * Settings-Variante, die nur im Speicher gehalten wird (kann allerdings mit
 * toByteArray in eine Persistenntform gebracht werden.
 */
public class InMemorySettings extends Settings {
	 ...
	 *
	 * @param compressed eine mit {@link StringTool#fold(byte[], int, Object)}
	 *                   erstellte komprimierte Hashtable
	 */
	 ...
	 *
	 * @param preset ein mit {@link StringTool#enPrintable(byte[])} erstellter
	 *               String
	 */
	public InMemorySettings(String preset) {
	 ...
	 *
	 * @return ein komprimiertes ByteArray, das als Parameter für den Konstrukltor
	 *         ByteArray dienen kann.
	 */
