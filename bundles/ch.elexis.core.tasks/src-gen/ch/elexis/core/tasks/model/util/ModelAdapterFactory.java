...
public class ModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelSwitch<Adapter> modelSwitch =
		new ModelSwitch<Adapter>() {
			@Override
			public Adapter caseITaskDescriptor(ITaskDescriptor object) {
				return createITaskDescriptorAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseITaskService(ITaskService object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.core.tasks.model.ITaskDescriptor <em>ITask Descriptor</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.core.tasks.model.ITask <em>ITask</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ch.elexis.core.tasks.model.ITaskService <em>ITask Service</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
