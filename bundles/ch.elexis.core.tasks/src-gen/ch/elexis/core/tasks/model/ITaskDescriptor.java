...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>ITask
 * Descriptor</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> Describes an runnable to be started with a given
 * runContext under the rigths of a user when triggerEvent occurs. <!--
 * end-model-doc -->
 *
 * <p>
 ...
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getReferenceId
 * <em>Reference Id</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getOwner
 * <em>Owner</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getOwnerNotification
 * <em>Owner Notification</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#isActive
 * <em>Active</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getIdentifiedRunnableId
 * <em>Identified Runnable Id</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getRunContext <em>Run
 * Context</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getTriggerType
 * <em>Trigger Type</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getTriggerParameters
 * <em>Trigger Parameters</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getRunner
 * <em>Runner</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#isSingleton
 * <em>Singleton</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#isSystem
 * <em>System</em>}</li>
 * <li>{@link ch.elexis.core.tasks.model.ITaskDescriptor#getTransientData
 * <em>Transient Data</em>}</li>
 * </ul>
 *
...
public interface ITaskDescriptor extends Identifiable, Deleteable {
	 ...
	 * reference this task in an other_task_state trigger event of a secondary task
	 * <!-- end-model-doc -->
	 * 
	 ...
	 * <em>Reference Id</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Reference Id</em>' attribute.
	 * @see #getReferenceId()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Owner Notification</b></em>' attribute. The
	 * default value is <code>"0"</code>. The literals are from the enumeration
	 * {@link ch.elexis.core.tasks.model.OwnerTaskNotification}. <!-- begin-user-doc
	 * -->
	 * <p>
	 ...
	 * <em>Owner Notification</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Owner Notification</em>' attribute.
	 * @see ch.elexis.core.tasks.model.OwnerTaskNotification
	 ...
	 * <!-- begin-model-doc --> if true run if triggerEvent happens <!--
	 * end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the
	 * '{@link ch.elexis.core.tasks.model.ITaskDescriptor#isActive <em>Active</em>}'
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Identified Runnable Id</em>' attribute isn't
	 ...
	 * <em>Identified Runnable Id</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Identified Runnable Id</em>' attribute.
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The context
	 * parameters to pass to ITask on being instantiated to a Job <!-- end-model-doc
	 * -->
	 * 
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Run Context</em>' attribute.
	 * @see #getRunContext()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Trigger Type</b></em>' attribute. The
	 * default value is <code>"MANUAL"</code>. The literals are from the enumeration
	 * {@link ch.elexis.core.tasks.model.TaskTriggerType}. <!-- begin-user-doc -->
	 * <!-- end-user-doc --> <!-- begin-model-doc --> The event type that will, in
	 * combination with the triggerEventCondition, lead to execution <!--
	 * end-model-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Trigger Type</em>' attribute.
	 * @see ch.elexis.core.tasks.model.TaskTriggerType
	 * @see #getTriggerType()
	 * @generated
	 */
	 ...
	 * <em>Trigger Parameters</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Trigger Parameters</em>' attribute.
	 ...
	 * that will run this task. Valid values are empty, stationId or ELEXIS-SERVER.
	 * Empty defines that any station may run this task. <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Singleton</b></em>' attribute. The default
	 * value is <code>"false"</code>. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * <!-- begin-model-doc --> Whether concurrent executions of an instantiation of
	 * this ITaskDescriptor are allowed. Even if this is set to false, if the
	 * reference IIdentifiedRunnable is singleton, it will be enforced to be true on
	 ...
	 * this task descriptor was programmatically generated and is relevant to the
	 * operational state of Elexis. Modification or deletion of this task descriptor
	 * and its derived task log entries leads to change of productive data. <!--
	 * end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the
	 * '{@link ch.elexis.core.tasks.model.ITaskDescriptor#isSystem <em>System</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Used to
	 * transport internal data, not stored into table. (e.g. next execution time of
	 * cron triggered task descriptor) <!-- end-model-doc -->
	 * 
	 ...
	 * TaskTriggerType.CRON this returns the cron configuration string as a parsed
	 * Cron object, else null <!-- end-model-doc -->
	 * 
