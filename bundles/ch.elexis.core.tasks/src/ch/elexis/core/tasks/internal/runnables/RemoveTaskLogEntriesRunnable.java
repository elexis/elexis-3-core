...
public class RemoveTaskLogEntriesRunnable implements IIdentifiedRunnable {
	...
	/**
	 * run parameter: entries lower equal finished at age in minutes, default:
	 * <code>80640</code> (8*7*24*60) - 8 weeks
	 */
	public static final String RCP_INTEGER_BEQ_FINISHEDAT_AGE_IN_MINUTES = "beqFinishedAtAge";
	/**
	 * run parameter: hard delete (delete from db) <code>true</code> or mark as
	 * deleted <code>false</code>, default: <code>true</code>
	 */
	public static final String RCP_BOOLEAN_HARD_DELETE = "hardDelete";

	/**
	 * run parameter: delete only completed tasks without warning or error
	 * <code>true</code> or all <code>false</code>, default: <code>true</code>
	 */
	...
	public Map<String, Serializable> run(Map<String, Serializable> runContext, IProgressMonitor progressMonitor,
		...
		query.and(ModelPackage.Literals.ITASK__FINISHED_AT, COMPARATOR.LESS_OR_EQUAL, ageBarrierInMilliseconds);
		...
		String message = itemsToDeleteSize + ((hardDelete) ? " removed from database" : " marked as deleted");
