...
public class RocketchatAppender extends AppenderBase<ILoggingEvent> {
	...
	protected void append(ILoggingEvent eventObject) {
		try {
			...
			boolean attachmentBased = (getContext().getProperty("attachmentBased") == null)
					? true
					: Boolean.valueOf(getContext().getProperty("attachmentBased"));
			IStatus postStatus = new IntegrationPostHandler(eventObject, identification, attachmentBased)
