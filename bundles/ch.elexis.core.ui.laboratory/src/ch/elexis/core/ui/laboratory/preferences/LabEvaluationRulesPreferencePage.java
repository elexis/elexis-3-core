...
public class LabEvaluationRulesPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public Control createContents(Composite parent) {
		...
		lblLabImportRulesHeader.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		lblLabImportRulesHeader.setText(Messages.LabEvaluationRulesPreferencePage_lblLabImportRulesHeader_text);
		...
		btnUseParameterRefValOnMissingResRefVal
				.setText(Messages.LabEvaluationRulesPreferencePage_btnUseParameterRefValOnMissingResRefVal_text);
		...
		grpAbsoluteResults.setText(Messages.LabEvaluationRulesPreferencePage_grpAbsoluteResults_text);
		grpAbsoluteResults.setLayout(new GridLayout(1, false));

		Button btnCheckStringEqualRefValResValIsNonPathologicAbsolute = new Button(grpAbsoluteResults, SWT.CHECK);
		...
		btnResultStartsWithPosIsPathologic
				.setText(Messages.LabEvaluationRulesPreferencePage_btnResultStartsWithPosIsPathologic_text);

		btnCheckNonStringEqualRefValResValIsPathologicAbsolute = new Button(grpAbsoluteResults, SWT.CHECK);
		...
		btnCheckNonStringEqualRefValResValIsPathologicAbsolute
				.addSelectionListener(new LERSelectionAdapter(Preferences.LABSETTINGS_CFG_EVAL_PREFIX_TYPE_ABSOLUT
						+ Preferences.LABSETTINGS_CFG_EVAL_REFVAL_NON_EQUAL_RESVAL_MEANS_PATHOLOGIC));
		btnCheckNonStringEqualRefValResValIsPathologicAbsolute
				.setSelection(ConfigServiceHolder.getGlobal(Preferences.LABSETTINGS_CFG_EVAL_PREFIX_TYPE_ABSOLUT
		...
		Button btnCheckStringEqualRefValResValIsNonPathologicText = new Button(grpTextResults, SWT.CHECK);
		...
		btnCheckNonStringEqualRefValResValIsPathologicText.setText(
				Messages.LabEvaluationRulesPreferencePage_btnCheckNonStringEqualRefValResValIsPathologicText_text);
		btnCheckNonStringEqualRefValResValIsPathologicText
				.addSelectionListener(new LERSelectionAdapter(Preferences.LABSETTINGS_CFG_EVAL_PREFIX_TYPE_TEXT
						+ Preferences.LABSETTINGS_CFG_EVAL_REFVAL_NON_EQUAL_RESVAL_MEANS_PATHOLOGIC));
		btnCheckNonStringEqualRefValResValIsPathologicText
				.setSelection(ConfigServiceHolder.getGlobal(Preferences.LABSETTINGS_CFG_EVAL_PREFIX_TYPE_TEXT
						+ Preferences.LABSETTINGS_CFG_EVAL_REFVAL_NON_EQUAL_RESVAL_MEANS_PATHOLOGIC, false));

		Label lblResultatEndbestimmt = new Label(grpResultEvaluation, SWT.NONE);
		lblResultatEndbestimmt.setText(Messages.LabEvaluationRulesPreferencePage_lblResultatEndbestimmt_text);
