...
public class LabEvaluationRulesPreferencePage extends PreferencePage
	...
	public Control createContents(Composite parent){
		...
		btnCheckStringEqualRefValResValIsNonPathologicAbsolute
			.setText(Messages.LabEvaluationRulesPreferencePage_btnCheckStringEqualRefValResValIsNonPathologicAbsolute_text);
		...
		btnResultStartsWithPosIsPathologic.setText(Messages.LabEvaluationRulesPreferencePage_btnResultStartsWithPosIsPathologic_text);
		
		btnCheckNonStringEqualRefValResValIsPathologicAbsolute =
			new Button(grpAbsoluteResults, SWT.CHECK);
		btnCheckNonStringEqualRefValResValIsPathologicAbsolute
			.setText(Messages.LabEvaluationRulesPreferencePage_btnCheckNonStringEqualRefValResValIsPathologicAbsolute_text);
