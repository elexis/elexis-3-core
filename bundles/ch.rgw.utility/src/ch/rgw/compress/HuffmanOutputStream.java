...
/**
 * A Stream that compresses its output on the fly with the Huffmann
 * algorithm<br>
 * A Huffman tree can be provided by the caller. The tree can be declared
 * dynamic to be recomputed regularly (for not in advance analyzable Stream with
 * very variable data).
 * 
 * @author Gerry
 */
public class HuffmanOutputStream extends OutputStream {
	 ...
	 * @param tree
	 *            tree a precomputed Huffman tree or null. If null, a standard tree
	 *            for textual files will be used.
	 * @param dynamic
	...
	/**
	 * terminate the stream: An EOF marker is written and he Stream is closed. If
	 * you don't store Informations about the length of the original data, you
