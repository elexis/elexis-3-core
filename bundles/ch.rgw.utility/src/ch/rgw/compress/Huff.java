...
public class Huff {
	 ...
	 * @param source
	 *            the source to compress. If tree is null, the Tree will be computed
	 *            from the source first and its frequency table is included in the
	 *            output.
	 ...
	 * @param source
	 *            A huffman compressed array as returned by encode(). If tree is
