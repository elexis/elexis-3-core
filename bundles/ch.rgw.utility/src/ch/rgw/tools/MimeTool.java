...
public class MimeTool {
	final static String[][] mapping = {{"pdf", "application/pdf"}, {"odt", "application/vnd.oasis.opendocument.text"},
			{"jpg", "image/jpeg"}, {"pps", "application/mspowerpoint"}, {"png", "image/png"},
	 ...
	 * @return the matching mimetype or application/octet-stream if none was found,
	 *         or the empty string if ext was null
	 */
