...
public class VersionedResource {
	 ...
	 *         gewünschte Version nicht existiert. Der zurückgelieferte Text enthält
	 *         einen einzeiligen Header, der die Versionsmummer, Zeit/Datum der
	 *         Erstellung und den Anmerkungstext enthält.
	 */
	...
	public static class ResourceItem implements Serializable {
		...
		public String getLabel() {
			...
			sb.append(new TimeTool(timestamp).toString(TimeTool.FULL_GER)).append(" - ").append(remark);
			return sb.toString();
		}
	}
}
