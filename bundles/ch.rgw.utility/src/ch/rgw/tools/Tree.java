 ...
 * sein kann (dann ist dieses Tree-Objekt die Wurzel des Baums) Jeder Tree trägt
 * ein beliebiges Datenobjekt (contents).
 */
public class Tree<T> {
	 ...
	 * wird, dann werden von getChildren() nur die geliefert, die dem Filter
	 * entsprechen
	 *
	...
	/**
	 * Filter nachträglich setzen. Der Filter wird für dieses und alle Children
	 * gesetzt.
	 *
	 * @param f der Filter
	 */
	...
	/**
	 * Erstes Kind-element liefern. Null, wenn keine Kinder. Dies macht im Gegensatz
	 * zu hasChildren() keine synchronisation!
	 *
	 * @return
	 */
