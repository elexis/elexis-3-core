...
public class TimeTool extends GregorianCalendar {
	 ...
	 *
	 * @param in a String formatted in one ofthe supported date/time formats
	 ...
	 *
	 * @param other another TimeTool which will not be affected
	 */
	 ...
	 *
	 * @param t   number of units
	 * @param res multiplicator for the units in milliseconds
	 */
	 ...
	 *
	 * @param pre a date/time String in one of the supported formats. If the String
	 ...
	 * Create a TimeTool set to a date/time as indicated by a String
	 *
	 * @param pre            a date/time String in one of the supported formats.
	 * @param bFailIfInvalid true: Throw an Exception if pre cannot be parsed,
	 *                       false: set to current date/time
	 */
	 ...
	 *
	 * @param millis Milliseconds after the epoch (same as
	 ...
	 *
	 * @param o source that will be untouched
	 */
	 ...
	 *
	 * @param o a source tTimeTool that will not be changed
	 */
	 ...
	 *
	 * @since 3.8
	 * @param days number of days compared to today may be positive (in the future)
