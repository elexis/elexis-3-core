...
public class OrderEntry
		extends AbstractIdDeleteModelAdapter<ch.elexis.core.jpa.entities.BestellungEntry>
	...
	public IArticle getArticle(){
		Optional<Identifiable> loaded = ModelUtil.getFromStoreToString(getEntity().getArticleType()
			+ IStoreToStringContribution.DOUBLECOLON + getEntity().getArticleId());
