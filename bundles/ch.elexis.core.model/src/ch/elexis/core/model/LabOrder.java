...
public class LabOrder extends AbstractIdDeleteModelAdapter<ch.elexis.core.jpa.entities.LabOrder>
	...
	public void setResult(ILabResult value) {
		if (value instanceof AbstractIdModelAdapter) {
			getEntityMarkDirty()
					.setResult((ch.elexis.core.jpa.entities.LabResult) ((AbstractIdModelAdapter<?>) value).getEntity());
		} else if (value == null) {
	...
	public void setItem(ILabItem value) {
		if (value instanceof AbstractIdModelAdapter) {
			getEntityMarkDirty()
					.setItem((ch.elexis.core.jpa.entities.LabItem) ((AbstractIdModelAdapter<?>) value).getEntity());
		} else if (value == null) {
	...
	public void setPatient(IPatient value) {
		if (value instanceof AbstractIdModelAdapter) {
			getEntityMarkDirty().setPatient((Kontakt) ((AbstractIdModelAdapter<?>) value).getEntity());
		} else if (value == null) {
