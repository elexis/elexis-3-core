...
public class HL7_OML_O21 extends HL7Writer {
	 ...
	 * @param plan                Abrechnungssystem (MV, UVG, VVG, KVG, usw)
	 * @param beginDate
	 * @param vnr                 Versicherungs-, Fall- oder Unfallnr
	 * @return
	 */
	public String createText(final HL7Patient patient, final HL7Kostentraeger rechnungsempfaenger,
			final HL7Kostentraeger kostentraeger, final String plan, final Date beginDate, final String fallNr,
	 ...
	 * @throws HL7Exception
	 */
	private void fillIN1(final IN1 in1, final HL7Patient patient, final HL7Kostentraeger kostentraeger,
		...
		in1.getIn13_InsuranceCompanyID(0).getCx1_IDNumber().setValue("EAN" + kostentraeger.getEan()); //$NON-NLS-1$
		in1.getIn13_InsuranceCompanyID(0).getCx4_AssigningAuthority().getHd1_NamespaceID().setValue("CHEMEDIAT"); //$NON-NLS-1$
