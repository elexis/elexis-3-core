...
public class FileImportStrategyUtil {
	 ...
	 *
	 * @param ok   <code>true</code> if the import was successful
	 * @param file
	 * @return fileHandle representing the new location
	 * @throws IOException
	 */
	public static IVirtualFilesystemHandle moveAfterImport(boolean ok, IVirtualFilesystemHandle fileHandle)
			throws IOException {
