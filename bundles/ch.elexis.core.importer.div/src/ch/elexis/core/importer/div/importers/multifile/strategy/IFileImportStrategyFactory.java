...
/**
 * a factory containing information about all the available
 * {@link IFileImportStrategy IFileImportStrategies} and for which file type
...
public interface IFileImportStrategyFactory {
	...
	/**
	 * Use this to create a {@link Map} containing the HL7File and it's
	 * {@link IFileImportStrategy}. <br>
	 * Add any connected files you'd like and their {@link IFileImportStrategy}
