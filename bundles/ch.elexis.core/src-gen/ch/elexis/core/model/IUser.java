 ...
 * <li>{@link ch.elexis.core.model.IUser#getHashedPassword <em>Hashed
 * Password</em>}</li>
 * <li>{@link ch.elexis.core.model.IUser#getSalt <em>Salt</em>}</li>
 * <li>{@link ch.elexis.core.model.IUser#getAssignedContact <em>Assigned
 * Contact</em>}</li>
 * <li>{@link ch.elexis.core.model.IUser#getRoles <em>Roles</em>}</li>
 * <li>{@link ch.elexis.core.model.IUser#isActive <em>Active</em>}</li>
 * <li>{@link ch.elexis.core.model.IUser#isAllowExternal <em>Allow
 * External</em>}</li>
 * <li>{@link ch.elexis.core.model.IUser#isAdministrator
...
public interface IUser extends Deleteable, Identifiable {
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IUser#getUsername
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hashed Password</em>' attribute isn't clear, there
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IUser#getHashedPassword
	 * <em>Hashed Password</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Hashed Password</em>' attribute.
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Salt</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IUser#getSalt
	 * <em>Salt</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Salt</em>' attribute.
	 * @see #getSalt()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IUser#getAssignedContact
	 * <em>Assigned Contact</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Assigned Contact</em>' reference.
	 ...
	 * contents are of type {@link ch.elexis.core.model.IRole}. <!-- begin-user-doc
	 * -->
	 * <p>
	 * This list is read only. Changes to it will not be stored. Use
	 * {@link #addRole(IRole)} to add a role to this user.
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Active</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IUser#isActive
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Allow External</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IUser#isAllowExternal
	 * <em>Allow External</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Allow External</em>' attribute.
	 * @see #isAllowExternal()
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Administrator</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IUser#isAdministrator
	 * <em>Administrator</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Administrator</em>' attribute.
	 * @see #isAdministrator()
	 * @generated
	 */
	 ...
	 * {@link #getRoles()#addRole(IRole)}, as it will not be stored. <!--
	 * end-user-doc -->
	 * 
