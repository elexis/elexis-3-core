 ...
 * '<em><b>IAppointment</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 ...
 * <li>{@link ch.elexis.core.model.IAppointment#getDurationMinutes <em>Duration
 * Minutes</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getSchedule
 * <em>Schedule</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getSubjectOrPatient <em>Subject
 * Or Patient</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getPriority
 * <em>Priority</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getTreatmentReason <em>Treatment
 * Reason</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getCaseType <em>Case
 * Type</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getInsuranceType <em>Insurance
 * Type</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getLinkgroup
 * <em>Linkgroup</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getExtension
 * <em>Extension</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getCreated
 * <em>Created</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getLastEdit <em>Last
 * Edit</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getStateHistory <em>State
 * History</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#isRecurring
 * <em>Recurring</em>}</li>
 * <li>{@link ch.elexis.core.model.IAppointment#getCreatedBy <em>Created
 * By</em>}</li>
 * </ul>
 *
...
public interface IAppointment extends IPeriod {
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getReason
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getState
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getType
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Schedule</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getSchedule
	 * <em>Schedule</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Created By</em>' reference isn't clear, there
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getCreatedBy
	 * <em>Created By</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Created By</em>' attribute.
	 * @see #getCreatedBy()
	 * @generated
	 */
	 ...
	 * Patient</em>}' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getPriority
	 ...
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc --> <!-- begin-model-doc --> Enumerated reason why this
	 * appointment was created. Currently used by RH connector <!-- end-model-doc
	 * -->
	 * 
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Treatment Reason</em>' attribute.
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Enumerated
	 * case type of this appointment. Currently used by RH connector <!--
	 * end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getCaseType
	 * <em>Case Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Case Type</em>' attribute.
	 * @see #getCaseType()
	 * @generated
	 */
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Enumerated
	 * insurance type of this appointment. Currently used by RH connector <!--
	 * end-model-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Insurance Type</em>' attribute.
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Linkgroup</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getLinkgroup
	 * <em>Linkgroup</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Linkgroup</em>' attribute.
	 * @see #getLinkgroup()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getExtension
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getCreated
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IAppointment#getLastEdit
	 * <em>Last Edit</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Last Edit</em>' attribute.
	 * @see #getLastEdit()
	 * @generated
	 */
	 ...
	 * History</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>State History</em>' attribute.
	 * @see #getStateHistory()
	 * @generated
	 */
