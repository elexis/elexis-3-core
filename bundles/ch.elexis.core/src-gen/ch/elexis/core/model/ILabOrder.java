 ...
 * <li>{@link ch.elexis.core.model.ILabOrder#getTimeStamp <em>Time
 * Stamp</em>}</li>
 * <li>{@link ch.elexis.core.model.ILabOrder#getObservationTime <em>Observation
 * Time</em>}</li>
 ...
 * <li>{@link ch.elexis.core.model.ILabOrder#getGroupName <em>Group
 * Name</em>}</li>
 * </ul>
 *
...
public interface ILabOrder extends Identifiable, Deleteable {
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getResult
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getItem
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getPatient
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getTimeStamp
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getUser
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getMandator
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Order Id</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getOrderId
	 * <em>Order Id</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Order Id</em>' attribute.
	 * @see #getOrderId()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getState
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabOrder#getGroupName
	 * <em>Group Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
