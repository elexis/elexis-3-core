 ...
 * '<em><b>ISticker</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> A sticker is a piece of information that may be
 * attached to an Identifiable. It can either exist for itself, or as an
 * attachedTo (bound to an identifiable) instance. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link ch.elexis.core.model.ISticker#getBackground
 * <em>Background</em>}</li>
 * <li>{@link ch.elexis.core.model.ISticker#getForeground
 * <em>Foreground</em>}</li>
 ...
 * <li>{@link ch.elexis.core.model.ISticker#getImportance
 * <em>Importance</em>}</li>
 * <li>{@link ch.elexis.core.model.ISticker#getImage <em>Image</em>}</li>
 * <li>{@link ch.elexis.core.model.ISticker#getAttachedTo <em>Attached
 * To</em>}</li>
 * <li>{@link ch.elexis.core.model.ISticker#getAttachedToData <em>Attached To
 * Data</em>}</li>
 * </ul>
 *
 ...
 *        ch.elexis.core.model.Deleteable ch.elexis.core.model.Identifiable
 *        ch.elexis.core.model.WithAssignableId"
 * @generated
 */
public interface ISticker extends Comparable<ISticker>, Deleteable, Identifiable, WithAssignableId {
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISticker#isVisible
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISticker#getName
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Importance</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISticker#getImportance
	 * <em>Importance</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Importance</em>' attribute.
	 * @see #getImportance()
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Image</em>' reference isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISticker#getImage
	 * <em>Image</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Image</em>' reference.
	 * @see #getImage()
	 * @generated
	 */
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> If not null
	 * this is an attached instance of a sticker. <!-- end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISticker#getAttachedTo
	 * <em>Attached To</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Attached To</em>' reference.
	 * @see #getAttachedTo()
	 * @generated
	 */
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> optionally
	 * attached data on an attached sticker instance <!-- end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISticker#getAttachedToData
	 * <em>Attached To Data</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Attached To Data</em>' attribute.
