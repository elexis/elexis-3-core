 ...
 * '<em><b>ICoverage</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 ...
 * <li>{@link ch.elexis.core.model.ICoverage#getDescription
 * <em>Description</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getReason <em>Reason</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getDateFrom <em>Date
 * From</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getCostBearer <em>Cost
 * Bearer</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getInsuranceNumber <em>Insurance
 * Number</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getDateTo <em>Date To</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getBillingProposalDate <em>Billing
 * Proposal Date</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getEncounters
 * <em>Encounters</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getBillingSystem <em>Billing
 * System</em>}</li>
 * <li>{@link ch.elexis.core.model.ICoverage#getGuarantor
 * <em>Guarantor</em>}</li>
 * </ul>
 *
...
public interface ICoverage extends Deleteable, Identifiable, WithExtInfo {
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ICoverage#getPatient
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ICoverage#getDescription
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ICoverage#getReason
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ICoverage#getDateFrom
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Billing System</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ICoverage#getBillingSystem
	 * <em>Billing System</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Billing System</em>' reference.
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Guarantor</em>' reference isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ICoverage#getGuarantor
	 * <em>Guarantor</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Guarantor</em>' reference.
	 * @see #getGuarantor()
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Cost Bearer</em>' reference isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ICoverage#getCostBearer
	 * <em>Cost Bearer</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Cost Bearer</em>' reference.
	 * @see #getCostBearer()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ICoverage#getDateTo
	 ...
	 * Proposal Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Billing Proposal Date</em>' attribute.
