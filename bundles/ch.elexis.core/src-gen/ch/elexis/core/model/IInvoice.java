 ...
 * '<em><b>IInvoice</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 ...
 * <li>{@link ch.elexis.core.model.IInvoice#getEncounters
 * <em>Encounters</em>}</li>
 ...
 * <li>{@link ch.elexis.core.model.IInvoice#getTotalAmount <em>Total
 * Amount</em>}</li>
 * <li>{@link ch.elexis.core.model.IInvoice#getOpenAmount <em>Open
 * Amount</em>}</li>
 * <li>{@link ch.elexis.core.model.IInvoice#getPayedAmount <em>Payed
 * Amount</em>}</li>
 * <li>{@link ch.elexis.core.model.IInvoice#getDemandAmount <em>Demand
 * Amount</em>}</li>
 * <li>{@link ch.elexis.core.model.IInvoice#getRemark <em>Remark</em>}</li>
 * <li>{@link ch.elexis.core.model.IInvoice#getStateDate <em>State
 * Date</em>}</li>
 * <li>{@link ch.elexis.core.model.IInvoice#getPayments <em>Payments</em>}</li>
 * <li>{@link ch.elexis.core.model.IInvoice#getTransactions
 * <em>Transactions</em>}</li>
 * <li>{@link ch.elexis.core.model.IInvoice#getAttachments
 * <em>Attachments</em>}</li>
 * </ul>
 *
...
public interface IInvoice extends Identifiable, Deleteable, WithExtInfo {
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getState
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getMandator
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getCoverage
	...
	/**
	 * Returns the value of the '<em><b>Encounters</b></em>' reference list. The
	 * list contents are of type {@link ch.elexis.core.model.IEncounter}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Encounters</em>' reference list isn't clear, there
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getDate
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getDateFrom
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getDateTo
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Total Amount</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getTotalAmount
	 * <em>Total Amount</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Open Amount</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Payed Amount</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Demand Amount</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getRemark
	...
	/**
	 * Returns the value of the '<em><b>Payments</b></em>' reference list. The list
	 * contents are of type {@link ch.elexis.core.model.IPayment}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Payments</em>' reference isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Transactions</b></em>' reference list. The
	 * list contents are of type {@link ch.elexis.core.model.IAccountTransaction}.
	...
	/**
	 * Returns the value of the '<em><b>Attachments</b></em>' reference list. The
	 * list contents are of type {@link ch.elexis.core.model.IDocument}. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IInvoice#getStateDate
	 * <em>State Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>State Date</em>' attribute.
	 * @see #getStateDate()
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @model type="ch.elexis.core.types.List&lt;org.eclipse.emf.ecore.EString&gt;"
	 *        many="false"
	 * @generated
	 */
