 ...
 * '<em><b>IMessage</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 ...
 * <li>{@link ch.elexis.core.model.IMessage#isSenderAcceptsAnswer <em>Sender
 * Accepts Answer</em>}</li>
 * <li>{@link ch.elexis.core.model.IMessage#getCreateDateTime <em>Create Date
 * Time</em>}</li>
 * <li>{@link ch.elexis.core.model.IMessage#getMessageText <em>Message
 * Text</em>}</li>
 * <li>{@link ch.elexis.core.model.IMessage#getMessageCodes <em>Message
 * Codes</em>}</li>
 * <li>{@link ch.elexis.core.model.IMessage#getMessagePriority <em>Message
 * Priority</em>}</li>
 * <li>{@link ch.elexis.core.model.IMessage#getPreferredTransporters
 * <em>Preferred Transporters</em>}</li>
 * </ul>
 *
...
public interface IMessage extends Identifiable, Deleteable {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sender</em>' reference isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc --> <!-- begin-model-doc --> The sender of the message.
	 * Possibly a userid that may be resolved to an IUser or another identifier
	 * (e.g. a station or system name). <!-- end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IMessage#getSender
	 * <em>Sender</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Sender</em>' attribute.
	 * @see #getSender()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Receiver</b></em>' attribute list. The list
	 * contents are of type {@link java.lang.String}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Receiver</em>' reference list isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc --> <!-- begin-model-doc --> The list of receivers. If
	 * empty, send message to everybody. <!-- end-model-doc -->
	 * 
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> wether
	 * the sender of this message will accept or handle an answer, i.e.
	 * unidirectional communication. <!-- end-model-doc -->
	 * 
	 ...
	 * Accepts Answer</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Sender Accepts Answer</em>' attribute.
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IMessage#getCreateDateTime
	 * <em>Create Date Time</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Create Date Time</em>' attribute.
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> the message
	 * text to be read by the receiving user(s) <!-- end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IMessage#getMessageText
	 * <em>Message Text</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Message Text</em>' attribute.
	 * @see #getMessageText()
	 * @generated
	 */
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> a message
	 * code to allow for extended representation and/or action configuration (e.g.
	 * show a specific image, perform a specific task) <!-- end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.IMessage#getMessageCodes
	 * <em>Message Codes</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Message Codes</em>' attribute.
	 * @see #getMessageCodes()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Message Priority</b></em>' attribute. The
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Message Priority</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Preferred Transporters</b></em>' attribute
	 * list. The list contents are of type {@link java.lang.String}. <!--
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> By default
	 * the MessageService tries to send over all transporters (ordered by priority
	 * descending) until one successfully sends it. Providing transporter ids here
	 * overrides the transporter selection and their order. <!-- end-model-doc -->
	 * 
