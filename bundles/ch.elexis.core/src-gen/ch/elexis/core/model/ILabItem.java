...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>ILab
 ...
 * <li>{@link ch.elexis.core.model.ILabItem#getReferenceMale <em>Reference
 * Male</em>}</li>
 * <li>{@link ch.elexis.core.model.ILabItem#getReferenceFemale <em>Reference
 * Female</em>}</li>
 ...
 * <li>{@link ch.elexis.core.model.ILabItem#getLoincCode <em>Loinc
 * Code</em>}</li>
 * <li>{@link ch.elexis.core.model.ILabItem#getBillingCode <em>Billing
 * Code</em>}</li>
...
public interface ILabItem extends Identifiable, Deleteable {
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getTyp
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Reference Male</em>' attribute isn't clear, there
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getReferenceMale
	 * <em>Reference Male</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getGroup
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getPriority
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getCode
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getUnit
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getName
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Digits</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getDigits
	 * <em>Digits</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#isVisible
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Formula</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getFormula
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Loinc Code</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getLoincCode
	 * <em>Loinc Code</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Loinc Code</em>' attribute.
	 * @see #getLoincCode()
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Billing Code</em>' attribute isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getBillingCode
	 * <em>Billing Code</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *            the new value of the '<em>Billing Code</em>' attribute.
	 * @see #getBillingCode()
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Export</em>' attribute isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ILabItem#getExport
	 * <em>Export</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Mappings</b></em>' reference list. The list
	 * contents are of type {@link ch.elexis.core.model.ILabMapping}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Mappings</em>' reference list isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * variable name of this LabItem as used in LabItems of type formula for
	 * cross-reference <!-- end-model-doc -->
	 * 
