...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>ISick
 * Certificate</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link ch.elexis.core.model.ISickCertificate#getPatient
 * <em>Patient</em>}</li>
 * <li>{@link ch.elexis.core.model.ISickCertificate#getCoverage
 * <em>Coverage</em>}</li>
 * <li>{@link ch.elexis.core.model.ISickCertificate#getLetter
 * <em>Letter</em>}</li>
 * <li>{@link ch.elexis.core.model.ISickCertificate#getPercent
 * <em>Percent</em>}</li>
 * <li>{@link ch.elexis.core.model.ISickCertificate#getDate <em>Date</em>}</li>
 * <li>{@link ch.elexis.core.model.ISickCertificate#getStart
 * <em>Start</em>}</li>
 * <li>{@link ch.elexis.core.model.ISickCertificate#getEnd <em>End</em>}</li>
 * <li>{@link ch.elexis.core.model.ISickCertificate#getReason
 * <em>Reason</em>}</li>
...
public interface ISickCertificate extends Identifiable, Deleteable {
	...
	/**
	 * Sets the value of the
	 * '{@link ch.elexis.core.model.ISickCertificate#getCoverage <em>Coverage</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISickCertificate#getLetter
	 * <em>Letter</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Letter</em>' reference.
	 * @see #getLetter()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISickCertificate#getDate
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISickCertificate#getStart
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISickCertificate#getEnd
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISickCertificate#getReason
	...
	/**
	 * Sets the value of the '{@link ch.elexis.core.model.ISickCertificate#getNote
	 * <em>Note</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
