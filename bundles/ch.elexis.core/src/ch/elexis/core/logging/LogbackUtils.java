...
public final class LogbackUtils {
	...
	/**
	 * Dynamically sets the logback log level for the given class to the specified
	 * level.
	 *
	 * @param loggerName Name of the logger to set its log level. If blank, root
	 *                   logger will be used.
	 * @param logLevel   One of the supported log levels: TRACE, DEBUG, INFO, WARN,
	 *                   ERROR, FATAL, OFF. {@code null} value is considered as
	 *                   'OFF'.
	 */
