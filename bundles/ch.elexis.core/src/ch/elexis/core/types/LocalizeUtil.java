...
public class LocalizeUtil {
	...
	/**
	 * Use with EMF generated not instances of {@link ILocalizedEnum}. Get the
	 * localized String for the {@link Enumerator}.
	 * 
	 * @param enumerator
	 * @return
	 */
	public static String getLocaleText(Enumerator enumerator) {
		if (enumerator != null) {
			try {
				...
				log.warn("No translation for {}_{} locale {} in {} ", enumerator.getClass().getSimpleName(),
						enumerator.getName(), Locale.getDefault(), ch.elexis.core.l10n.Messages.class.getName());
	...
	/**
	 * Next procedure is never use, but avoids warnings when starting Elexis because
	 * of unused messages
	 */
