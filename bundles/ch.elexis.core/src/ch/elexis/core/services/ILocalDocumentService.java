...
/**
 * Service interface to manage documents on the local file system. Documents
 * (Omnivore, Brief) are exported to the local file system.
 *
 * @author thomas
 *
 */
public interface ILocalDocumentService {
	...
	/**
	 * Register a save handler implementation to be used saving an instance of
	 * clazz.
	 *
	 * @param clazz
	 * @param saveHandler
	...
	/**
	 * Save the document from the managed list. Throws an
	 * {@link IllegalStateException} if no {@link ISaveHandler} found for the
	 * documentSource.
	 *
	 * @param documentSource
	 * @return
	...
	/**
	 * Add the document source to the managed local documents, and return the local
	 * file. The conflict handler is used if the file already exists. Throws an
	 * {@link IllegalStateException} if no {@link ILoadHandler} found for the
	 * documentSource.
	 *
	 * @param documentSource
	...
	/**
	 * Get a temporary {@link File} for the documentSource. Throws an
	 * {@link IllegalStateException} if no {@link ILoadHandler} found for the
	 * documentSource.
	 *
	 * @param documentSource
	...
	/**
	 * Remove the document from the managed list. Document will be removed even if
	 * local file is not accessible.
	 *
	 * @param documentSource
	 */
	...
	/**
	 * Remove the document from the managed list. The delete parameter specified
	 * whether deleting from filesystem should be done.
	 *
	 * @param documentSource
	 * @param delete
	 */
	...
	/**
	 * Remove the managed local document from the managed list. The conflict handler
	 * is used if the managed local file can not be deleted.
	 *
	 * @param documentSource
	 */
