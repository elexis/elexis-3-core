...
public interface INativeQuery {
	 ...
	 * <p>
	 * <i> Named parameters follow the rules for identifiers defined in Section
	 * 4.4.1. The use of named parameters applies to the Java Persistence query
	 * language, and is not defined for native queries. Only positional parameter
	 * binding may be portably used for native queries. </i>
	 * </p>
	 *
	 * @param paramters
	 * @return
