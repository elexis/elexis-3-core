...
public interface ICodeElementService {
	...
	/**
	 * Create a String representation of the {@link ICodeElement}. A
	 * {@link ICodeElement} can the be loaded using the
	 * {@link ICodeElementService#loadFromString(String, HashMap)} method.
	 *
	 * @param element
	 * @return
	 */
	...
	/**
	 * Load a {@link ICodeElement} instance using its String representation,
	 * generated using the {@link ICodeElementService#storeToString(ICodeElement)}
	 * method (this is NOT equivalent to the storeToString created by the
	 * {@link IStoreToStringService}).<br/>
	 * <br/>
	 * The returned {@link ICodeElement} will have the same SystemName and Code
	 * property, the rest can differ from the {@link ICodeElement} used to generate
	 * the String. New imports of the {@link ICodeElement} dataset, or some value in
	 * the context can also change the returned object.
	 *
	 * @param storeToString
	 * @param context       may be <code>null</code>
	 * @return
	 */
	public default Optional<ICodeElement> loadFromString(String storeToString, Map<Object, Object> context) {
	...
	/**
	 * Get the {@link ICodeElementServiceContribution} with matching
	 * {@link CodeElementTyp} and code system name.
	 *
	 * @param typ
