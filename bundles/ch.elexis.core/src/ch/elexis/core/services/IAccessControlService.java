...
public interface IAccessControlService {
	...
	/**
	 * Initializes the default access control set, including all contributions made
	 * by "currently" available plugins.
	 */
	 ...
	 *
	 * @param roledId the id, resolvable to a {@link Role}
	 * @param ace
