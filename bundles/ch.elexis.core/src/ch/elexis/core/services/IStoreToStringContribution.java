...
public interface IStoreToStringContribution {
	...
	/**
	 * Split a storeToString into an array containing the type and the id. Expected
	 * separator string is {@link #DOUBLECOLON}.
	 *
	 * @param storeToString
	 * @return a size 2 array with type [0] and id [1] or <code>null</code> in
	 *         either [0] or [1]
	 */
