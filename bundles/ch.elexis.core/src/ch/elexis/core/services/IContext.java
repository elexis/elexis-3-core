...
public interface IContext {
	...
	/**
	 * Get a string identifying this station (do not use the $ sign within the
	 * id).<br>
	 * If multiple instances are run on a station, the stationId has to append the
	 * instance number with <code>$</code>.<br>
	 * For example: first instance <code>stationId</code>, second instance
	 * <code>stationId$2</code>
	 *
	 * @return
	 */
