...
/**
 * Service to handle filesystem resources. These resources may be located on the local computer, or on
 * a remote network source. Currently we support the following URL handles.
 * <ol>
...
public interface IVirtualFilesystemService {
	...
	public interface IVirtualFilesystemHandle {
		...
		/**
		 * Change into a possibly not yet existing subdir
		 * 
		 * @param string
		 * @return
		 */
