...
public interface IContextService {
	 ...
	 *
	 * @param patient or <code>null</code> to unset
	 */
	 ...
	 *
	 * @param coverage or <code>null</code> to unset
	 */
	...
	/**
	 * Release the context, and make it available for garbage collection. Root
	 * context can not be released.
	 *
	 * @param context
	 * @return
	 */
	...
	/**
	 * Post an Event using a topic (see {@link ElexisEventTopics}), and an optional
	 * object.
	 *
	 * @param eventTopic
	 * @param object
