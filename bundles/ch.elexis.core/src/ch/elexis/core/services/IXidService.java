...
public interface IXidService {
	 ...
	 * @param domainName
	 * @param simpleName
	 * @param quality    see {@link XidConstants} for values
	 * @return
	 */
	 ...
	 * @param domainName
	 * @param simpleName
	 * @param qualitysee {@link XidConstants} for values
	 * @return
	 */
	public IXidDomain localRegisterXIDDomainIfNotExists(String domainName, String simpleName, int quality);

	/**
	 * Translate a simple name to a domain name. If the name is already a domain
	 * name it is returned unchanged.
	 *
	 * @param domainName
	 * @return
	 */
	 ...
	 * domain and domainId. If there is already an existing {@link IXid} for the
	 * domain and the updateIfExists parameter is true, the information is updated
	 * and return value is true, else nothing is changed and return value is false.
	 * If a new {@link IXid} is created return value is true.
	 *
	 * @param identifiable
	 * @param domain
	 * @param id
	 ...
	 * @return
	 */
	public boolean addXid(Identifiable identifiable, String domain, String domainId, boolean updateIfExists);

	/**
	 * Get a {@link IXid} instance with the provided {@link Identifiable} as object
	 * and matching the provided domain.
	 *
	 * @param identifiable
	 * @param domain
	 * @return
