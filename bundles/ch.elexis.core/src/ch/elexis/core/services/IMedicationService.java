...
public interface IMedicationService {
	...
	/**
	 * Create a {@link IRecipe} with the provided {@link IPatient} and prescriptions. The
	 * prescriptions are not altered, but new {@link IPrescription}s are created with
	 * {@link EntryType#RECIPE}. The {@link IRecipe} an its {@link IPrescription} entries are
	 * persisted.
	 * 
	 * @param patient
	 * @param prescRecipes
