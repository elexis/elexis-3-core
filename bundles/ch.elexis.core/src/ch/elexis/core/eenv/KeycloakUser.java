...
public class KeycloakUser implements IUser {
	...
	/**
	 * Keycloak Represented User. This users data is populated via incoming JTW token. It maps to
	 * the Elexis user world employing the core model service.
	 * 
	 ...
	 * @param familyName
	 * @param issueTime
	 *            jwt Issued At time (in seconds since Unix epoch)
	 * @param expirationTime
	 */
	private KeycloakUser(IModelService coreModelService, String preferredUsername, String name,
		String familyName, long issueTime, long expirationTime, String assignedContactId){
