...
/**
 * System environment properties that are considered by Elexis. This is mostly targeted for Docker
 * configuration of the Elexis-Server as username and password should not be held as environment
 * properties in a non-server system.<br>
