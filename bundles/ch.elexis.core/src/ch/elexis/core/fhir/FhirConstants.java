...
public class FhirConstants {
	...
	/**
	 * eAU (AUF) - lend from / aligned to https://simplifier.net/EAU/~introduction, should be replaced with
	 * FHIR CH specific implementation when (and if) it becomes available
	 */
