...
public class ACE {
	 ...
	 * 
	 * @param parent
	 *            the parent ACE. If this is a top-level ACE, use {@link #ACE_ROOT}
	 *            as parent.
	 * @param name
	 *            the internal, immutable name of this ACE. Should be unique.
	 *            Therefore, it is recommended to prefix the name with the plugin ID
	 * @param localizedName
	 *            the name that will be presented to the user. This should be a
	 *            translatable String
	 */
