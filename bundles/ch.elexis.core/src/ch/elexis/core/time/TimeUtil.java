...
public class TimeUtil {
	...
	public static Date toDate(LocalDate localDate) {
		...
		return java.util.Date.from(localDate.atTime(9, 0).atZone(ZoneId.systemDefault()).toInstant());
	}
	...
	public static XMLGregorianCalendar toXMLGregorianCalendar(Date date) {
		...
		return toXMLGregorianCalendar(date.toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime());
	}
	...
	/**
	 * Convert the {@link XMLGregorianCalendar} value to a LocalDateTime in the
	...
	public static LocalDateTime toLocalDateTime(XMLGregorianCalendar xcal) {
		return xcal.toGregorianCalendar().toZonedDateTime().withZoneSameInstant(ZoneId.systemDefault())
				.toLocalDateTime();
	}
	...
	public static Duration determineAbsoluteDurationBetweenXMLGregorianCalender(XMLGregorianCalendar ts1,
	 ...
	 * @return
	 */
	public static XMLGregorianCalendar toXMLGregorianCalendarFailSafe(LocalDate localDate, Logger log) {
		try {
			if (localDate == null) {
	...
	public static XMLGregorianCalendar toXMLGregorianCalendarFailSafe(LocalDateTime localDateTime, Logger log) {
		try {
			if (localDateTime == null) {
