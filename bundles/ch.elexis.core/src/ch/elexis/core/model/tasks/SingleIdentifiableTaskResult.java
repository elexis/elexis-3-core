...
/**
 * Carry the information of a result on a single identifiable with a running
 * task.
 */
public class SingleIdentifiableTaskResult {
	...
	public SingleIdentifiableTaskResult(String identifiableStoreToString, String resultCode, String message) {
