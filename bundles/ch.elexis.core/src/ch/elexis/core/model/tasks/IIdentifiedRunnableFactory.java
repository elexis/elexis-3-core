...
public interface IIdentifiedRunnableFactory {
	...
	/**
	 * Before calling {@link #getProvidedRunnables()} the first time, this method
	 * will be called. Do not introduce a dependency to ITaskService on
	 * instantiating this class, it would be circular. Use this method instead.
	 *
	 * If an exception is thrown within this method, the factory will not be added.
	 *
	 * @param taskService castable to ITaskService
	 */
