...
public interface IObservation extends IFinding {
	public enum ObservationCategory {
		SOCIALHISTORY("social-history"), VITALSIGNS("vital-signs"), IMAGING("imaging"), LABORATORY(
				"laboratory"), PROCEDURE("procedure"), SURVEY("survey"), EXAM("exam"), THERAPY(
						"therapy"), SOAP_SUBJECTIVE("subjective"), SOAP_OBJECTIVE("objective"), UNKNOWN("unknown");
	...
	public enum ObservationCode {
		ANAM_PERSONAL(IdentifierSystem.ELEXIS_ANAMNESE, "personal"), ANAM_RISK(IdentifierSystem.ELEXIS_ANAMNESE,
				"risk");
		...
		public boolean isSame(ICoding iCoding) {
			return code != null && code.equals(iCoding.getCode()) && identifierSystem != null
					&& identifierSystem.getSystem() != null && identifierSystem.getSystem().equals(iCoding.getSystem());
		}
	}
	...
	/**
	 * Get an URI String describing the origin of the {@link IObservation}. Use
	 * {@link UriType} to determine the type.
	 * 
	 * @return
	 */
	...
	/**
	 * Set an URI String describing the origin of the {@link IObservation}. Use
	 * {@link UriType} to determine the type. Max length are 255 characters.
	 * 
	 * @param uri
	 */
