...
/**
 * The main entry point to load code systems. Different
 * {@link ICodingContribution} implementations provide access to the coding of
 * different code systems. There should be 1 implementation of a
 * {@link ILocalCodingContribution} available, which can be used to create new
 * codings.
 * 
 * @author thomas
 *
...
public interface ICodingService {
	...
	/**
	 * Return a matching {@link ICoding} instance for the requested code of the
	 * system, or empty if there is no such code.
	 * 
	 * @param code
	 * @return
	 */
	...
	/**
	 * Remove a {@link ICoding} from the {@link ILocalCodingContribution}
	 * implementation.
	 * 
	 * @param coding
	 */
	...
	/**
	 * Get a label for a {@link ICoding} object. The code system is represented with
	 * the last part of the system uri. <br />
	 * Examples: <br />
	 ...
	 * represented. The code system is represented with the last part of the system
	 * uri. <br />
	 * Examples: <br />
	 * icd:G21.0 <br />
	 * icpc-2:K02
