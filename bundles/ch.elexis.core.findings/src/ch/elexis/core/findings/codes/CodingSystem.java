...
public enum CodingSystem {
	...
	ELEXIS_ENCOUNTER_TYPE("www.elexis.info/encounter/type"), ICD_DE_CODESYSTEM("http://hl7.org/fhir/sid/icd-10-de"),
	ICPC2_CODESYSTEM("http://hl7.org/fhir/sid/icpc-2"), ELEXIS_TARMED_CODESYSTEM("www.elexis.info/billing/tarmed"),
