...
public enum CodingSystem {
	ELEXIS_TARMED_CODESYSTEM("www.elexis.info/billing/tarmed"), ELEXIS_LOCAL_CODESYSTEM("www.elexis.info/coding/local"),
	ELEXIS_COVERAGE_TYPE("www.elexis.info/coverage/type"), ELEXIS_COVERAGE_REASON("www.elexis.info/coverage/reason"),
	...
	/**
	 * The degree in percent of the work incapacity, see
	 * {@link FhirConstants#DE_EAU_SYSTEM}
	 */
