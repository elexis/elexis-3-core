...
/**
 * The main entry point to load value sets. Different
 * {@link IValueSetContribution} implementations provide access to the coding of
 * different value sets. It is not required that all codes of value sets can
 * also accessible via {@link ICodingService}.
 * 
 * @author thomas
 *
 */
public interface IValueSetService {
	...
	/**
	 * Convert the list of {@link ICoding} to a map with {@link ICoding#getCode()}
	 * as keys;
	 * 
	 * @param coding
	 * @return
