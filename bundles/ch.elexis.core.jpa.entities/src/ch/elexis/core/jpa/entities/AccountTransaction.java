...
@NamedQuery(name = "AccountTransaction.balance.patient", query = "SELECT SUM(CAST(at.amount AS NUMERIC(8,0))) FROM AccountTransaction at WHERE at.deleted = false AND at.patient = :patient")
