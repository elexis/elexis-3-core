...
/**
 * Abstract class for {@link EntityWithId} instances. This is NOT a JPA {@link MappedSuperclass} as
 * that can cause trouble with weaving. Only implement non JPA logic here.
 * 
 * @author thomas
 *
 */
