...
public class MandantTextPlaceholderResolver implements ITextPlaceholderResolver {
	...
	private enum MandantAttribute implements ILocalizedEnum {
		Name("Nachname des Mandanten"), Vorname("Vorname des Mandanten"), Titel("Titel des Mandanten"), Anrede(
				"Anrede des Mandanten"), Anschrift("Mehrzeilige Anschrift"), Anschriftzeile("Einzeilige Anschrift");
