...
public enum Images {
	...
	IMG_WIZ_DAY, IMG_CALENDAR, IMG_COUNTER_STOP, IMG_USER_IDLE, IMG_SYSTEM_MONITOR, IMG_BELL_EXCLAMATION, IMG_SORT_DATE, IMG_SORT_DATE_DESCENDING, IMG_CARDS, IMG_NOBILLING, IMG_BAGGAGE_CART_BOX, IMG_HAND, IMG_CLOCK, IMG_TASK, IMG_SCANNER, IMG_DRAWER, IMG_DRAWER_ARROW, IMG_ADD, IMG_INBOX, IMG_OUTBOX;
