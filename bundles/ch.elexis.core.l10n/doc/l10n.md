...
*** `ch.elexis.core.releng/i18n_gen_info.rb --to-plugin-properties */bundles`
...
* Use one single message id 
      Do not concatenate string. Use [MessageFormat.format](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/text/MessageFormat.html)
      to inject one or more variables at the correct place in a message, eg. for a text like "Added 5 of total 15 items".
