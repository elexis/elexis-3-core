...
Use always the EclipseResourceBundle Editor. It allows you to modify all languages in a single view and neatly sorts each properties files alphabetically.
