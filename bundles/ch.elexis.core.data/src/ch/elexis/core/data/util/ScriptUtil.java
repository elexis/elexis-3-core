...
public class ScriptUtil {
	...
	/**
	 * Get a data type from a plugin that implements IDataAccess and plugs into the
	 * EP DatAccess
	 *
	 * @param connector the string describing the desired data. the connector string
