...
public class FallDataAccessor implements IDataAccess {
	...
	private Element[] elements = {
			new Element(IDataAccess.TYPE.STRING, KOSTENTRAEGER_UMLAUT, "[Fall:-:-:Kostentraeger]", null, 0),
			new Element(IDataAccess.TYPE.STRING, KOSTENTRAEGER_KUERZEL_UMLAUT, "[Fall:-:-:KostentraegerKuerzel]", null,
					0),
			new Element(IDataAccess.TYPE.STRING, KOSTENTRAEGER_ORT_UMLAUT, "[Fall:-:-:KostentraegerOrt]", null, 0),
			new Element(IDataAccess.TYPE.STRING, ARBEITGEBER, "[Fall:-:-:Arbeitgeber]", null, 0),
			new Element(IDataAccess.TYPE.STRING, ARBEITGEBER_KUERZEL, "[Fall:-:-:ArbeitgeberKuerzel]", null, 0),
			new Element(IDataAccess.TYPE.STRING, ZUWEISER, "[Fall:-:-:Zuweiser]", null, 0),
			new Element(IDataAccess.TYPE.STRING, ZUWEISER_KUERZEL, "[Fall:-:-:ZuweiserKuerzel]", null, 0) };
