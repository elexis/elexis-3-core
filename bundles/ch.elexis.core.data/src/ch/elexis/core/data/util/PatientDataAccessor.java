...
public class PatientDataAccessor implements IDataAccess {
	...
	private Element[] elements = {
			new Element(IDataAccess.TYPE.STRING, GESETZVERTRETER_UMLAUT, "[Patient:-:-:GesetzVertreter]", null, 0),
			new Element(IDataAccess.TYPE.STRING, GESETZVERTRETER_KUERZEL_UMLAUT, "[Patient:-:-:GesetzVertreterKuerzel]",
					null, 0),
			new Element(IDataAccess.TYPE.STRING, GESETZVERTRETER_ORT_UMLAUT, "[Patient:-:-:GesetzVertreterOrt]", null,
					0),
			new Element(IDataAccess.TYPE.STRING, STAMMARZT_UMLAUT, "[Patient:-:-:Stammarzt]", null, 0),
			new Element(IDataAccess.TYPE.STRING, STAMMARZT_KUERZEL_UMLAUT, "[Patient:-:-:StammarztKuerzel]", null, 0),
			new Element(IDataAccess.TYPE.STRING, STAMMARZT_ORT_UMLAUT, "[Patient:-:-:StammarztOrt]", null, 0) };
