...
public interface IDataAccess {
	...
	public static class Element {
		...
		public Element(final TYPE typ, final String name, final String ph, final Class<? extends PersistentObject> ref,
	 ...
	 *
	 * @param descriptor      description of the Object to retrieve (name and
	 *                        fields)
	 * @param dependentObject Type of PersistentObject this data depends on
	 * @param dates           date definition. either a date string or "all" or
	 *                        "last"
