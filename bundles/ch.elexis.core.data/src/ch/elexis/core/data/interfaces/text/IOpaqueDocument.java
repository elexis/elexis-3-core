 ...
 * that can be stored and retrieved in the system. The IOpaqueDocument holds the
 * reference to the original contents and some metadata. The Interface has no
 * means to analyze the contents of the document. thus Opaque.
 * 
 * @author gerry
 * 
 */
public interface IOpaqueDocument {
	...
	/**
	 * Title for the document. Not more than 80 characters. Must not be null and
	 * must not be empty
	 */
	 ...
	 * 
	 * @return The MimeType (see rfc2045) of the document. May be null or empty if
	 *         not known
	 */
	...
	/**
	 * A globally unique identifier for this document. The implementation must
	 * ensure that (1) No two documents in the world ever exist with the same GUID,
	 * and (2) A document will always have the same GUID assigned within this
	 * application, i.e. the call getGUID on the same document will always return
	 * the same value.
	 * 
	 * @return
	 */
