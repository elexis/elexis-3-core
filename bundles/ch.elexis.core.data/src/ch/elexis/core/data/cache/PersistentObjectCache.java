...
public interface PersistentObjectCache<K> {

	/**
	 * Insert an Object that will stay until it is manually removed, or memory gets
	 * low, or at most for ICacheable#getCacheTime seconds
	 */
	 ...
	 * 
	 * @return the object or null, if the object was expired or removed bei the
	 *         garbage collector.
	 */
