...
public interface IDocumentManager {
	 ...
	 *
	 * @param id ID of the Object (as generated with addDocument)
	 * @return
	 */
	 ...
	 *
	 * @param pat           The patient the documents belong to
	 * @param categoryMatch the category or categories to match
	 * @param titleMatch    title
	 * @param keywordMatch  keyword to find. Will match if at least one of the
	 *                      documents keywords match the parameter
	 * @param dateMatch     match only documents woth dates within the given
	 *                      timespan
	 * @param contentsMatch find a match in the contents of the document. Note: This
	 *                      is not supported by all documentmanagers and it might be
	 *                      very inefficient! If the parameter is not null and the
	 *                      implementation does not support contentMatch, it throws
	 *                      an ElexisException EE_NOT_SUPPORTED.
