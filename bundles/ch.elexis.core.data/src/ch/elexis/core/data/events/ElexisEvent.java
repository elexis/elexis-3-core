/*******************************************************************************
 * Copyright (c) 2009-2017, G. Weirich and Elexis
 ...
 *
 * Note: Note: this class has a natural ordering that is inconsistent with
 * equals
 *
 * @author gerry
 *
...
public final class ElexisEvent implements Comparable<ElexisEvent> {
	 ...
	 * @param type
	 * @param priority
	 * @param updatedAttribute in case of {@link #EVENT_UPDATE} the updated
	 *                         attribute
	 * @since 3.1
	 */
	public ElexisEvent(final Object genericObject, Class<?> c, int type, int priority,
	...
	/**
	 *
	 * @return if {@link #EVENT_UPDATE} (possibly) the updatedAttribute or
	 *         <code>null</code>
	 */
	...
	/**
	 * Check whether this event matches a template event. this method is only used
	 * internally by the framework and not intended to be called or overridden by
	 * clients
	 *
	...
	/**
	 * Decide whether an Event is logically identically to an other (i.e. describes
	 * the same operation on the same (type of) object)
	 *
	...
	public String toString() {
		return "ElexisEvent [obj=" + obj + ", genericObject=" + genericObject + ", objClass=" + objClass + ", type="
				+ type + ", priority=" + priority + ", updatedAttribute=" + updatedAttribute + "]";
	}
}
