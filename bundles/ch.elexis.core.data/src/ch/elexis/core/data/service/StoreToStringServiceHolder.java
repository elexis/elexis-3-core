...
public class StoreToStringServiceHolder {
	...
	/**
	 * Get the elexis store to string for the object. Can handle
	 * {@link Identifiable} and {@link PersistentObject} objects.
	 *
	 * @param object
	 * @return
	 */
	...
	/**
	 * Load the object identified by the elexis storeToString. Can handle
	 * {@link Identifiable} and {@link PersistentObject} objects.
	 *
	 * @param storeToString
	 * @return
