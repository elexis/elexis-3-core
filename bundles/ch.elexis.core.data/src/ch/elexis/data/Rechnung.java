...
public class Rechnung extends PersistentObject {
	 ...
	 * 
	 * @param reopen
	 *            wenn True werden die in dieser Rechnung enthaltenen Behandlungen
	 *            wieder freigegeben, andernfalls bleiben sie abgeschlossen.
	 ...
	 * @param expiryDate
	 *            the date this temporary state will expire, setting the invoice
