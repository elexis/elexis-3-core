...
public class BezugsKontaktRelation {
	...
	public String getCfgString() {
		...
		buffer.append(srcRelationType != null ? srcRelationType.getValue() : RelationshipType.AGENERIC_VALUE);
		buffer.append(VALUE_SEPERATOR);
		buffer.append(destRelationType != null ? destRelationType.getValue() : RelationshipType.AGENERIC_VALUE);
