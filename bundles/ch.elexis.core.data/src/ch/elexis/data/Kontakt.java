...
public class Kontakt extends PersistentObject {
	...
	public void setAnschrift(Anschrift adr) {
		if (adr != null) {
			set(new String[]{FLD_STREET, FLD_ZIP, FLD_PLACE, FLD_COUNTRY}, adr.getStrasse(), adr.getPlz(), adr.getOrt(),
					adr.getLand());
		}
	}
	 ...
	 *            die Adresse
	 * @param sBezug
	 *            ein Text, der die Beziehung dieser Adresse zum Kontakt definiert
	 *            (z.B. "Geschäftlich" oder "Orthopäde" oder so)
	 */
