...
/**
 * A Stock is the definition of a storage for articles. A stock is referred to
 * by {@link StockEntry} elements, which represent the articles in store.
 *
 * @since 3.2
 */
public class Stock extends PersistentObject implements IStock {
	...
	public Stock(final String code, int globalPriority) {
		create(null);
		set(new String[] { FLD_CODE, FLD_PRIORITY }, code, Integer.toString(globalPriority));
	}
