...
public class OutputLog extends PersistentObject {
	...
	public OutputLog(PersistentObject po, IOutputter io) {
		create(null);
		set(new String[]{FLD_OBJECT_ID, FLD_OBJECT_TYPE, FLD_DATE, FLD_OUTPUTTER}, po.getId(), po.getClass().getName(),
				new TimeTool().toString(TimeTool.DATE_GER), io.getOutputterID());
