...
public abstract class PersistentObject implements IPersistentObject {
	 ...
	 * 
	 * @param customID
	 *            Wenn eine ID (muss eindeutig sein!) vorgegeben werden soll. Bei
	 *            null wird eine generiert.
	 * @return true bei Erfolg
	 */
	 ...
	 * @param fields
	 *            the fields to include in the insert statement, does currently
	 *            partially support special field types as defined in
	 *            {@link #addMapping(String, String...)}. Use <code>null</code> if
	 *            not applied
	 * @param values
	 *            the values, the length of this array must be equal to the fields
	 *            array length. Use <code>null</code> if not applied
	 * @param sendEvent
	...
	/**
	 * @param checkNulls
	 *            wether the returned values should be <code>null</code> safe, that
	 *            is no <code>null</code> values, but only ""
	 * @param fields
	 ...
	 * @param mode
	 *            Testmodus (MATCH_EXACT, MATCH_BEGIN, MATCH_REGEXP, MATCH_CONTAIN
	 *            oder MATCH_AUTO)
	 * @param bSkipInexisting
	 *            don't return false if a fieldname is not found but skip this field
	 *            instead
