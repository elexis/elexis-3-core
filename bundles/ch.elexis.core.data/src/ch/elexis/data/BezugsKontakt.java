...
public class BezugsKontakt extends PersistentObject {
	...
	public BezugsKontakt(Kontakt kontakt, Kontakt adr, BezugsKontaktRelation bezugsKontaktType) {
		...
		set(new String[] { MY_ID, OTHER_ID, RELATION, FLD_MY_RTYPE, FLD_OTHER_RTYPE }, kontakt.getId(), adr.getId(),
				bezugsKontaktType.getName(), String.valueOf(bezugsKontaktType.getDestRelationType().getValue()),
	...
	public void updateRelation(BezugsKontaktRelation bezugsKontaktRelation) {
		set(new String[] { BezugsKontakt.RELATION, BezugsKontakt.FLD_MY_RTYPE, BezugsKontakt.FLD_OTHER_RTYPE },
				bezugsKontaktRelation.getName(), String.valueOf(bezugsKontaktRelation.getDestRelationType().getValue()),
