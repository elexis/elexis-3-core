...
public class NamedBlob2 extends PersistentObject {
	...
	/**
	 * put the contents as array of bytes. the array will be stored in compressed
	 * form
	 *
	 ...
	 * @param bFailIfExists true - create if not exists, otherwise return null.
	 *                      false: if exists:_ return existing
	 *
	 */
