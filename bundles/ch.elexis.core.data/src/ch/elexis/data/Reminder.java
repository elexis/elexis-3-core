...
public class Reminder extends PersistentObject implements Comparable<Reminder> {
	 ...
	 * 
	 * @param ident
	 *            The contact (i.e. Patient) the reminder belongs to. If
	 *            <code>null</code>, the reminder will be attributed to the current
	 *            user, making it a non-patient-related reminder.
	 * @param due
	 *            A date string
	 * @param typ
	 ...
	 * 
	 * @param responsibles
	 *            if <code>null</code> ALL are responsible, if empty list NO ONE is
	 *            responsible, else the respective {@link Anwender}
	 * @since 3.4
	 */
	 ...
	 * @param patient
	 *            limit the selection to reminders concerning a specific
	 *            {@link Patient}
	 * @param onlyPopup
	 *            do return only reminders with
