...
public class Patient extends Person {
	 ...
	 * @param s
	 *            sexe must be entered as (in German) m for male and w for female
	 *            (weiblich)
	 ...
	 * 
	 * @param force
	 *            bei true wird der Patient auf jeden Faöll gelöscht, bei false nur,
	 *            wenn keine Fälle von ihm existieren.
