...
public class BestellungEntry extends PersistentObject implements IOrderEntry {
	...
	public BestellungEntry(Bestellung order, Artikel article, @Nullable Stock stock, @Nullable Kontakt provider,
			int count) {
		String[] fields = new String[]{FLD_BESTELLUNG, FLD_ARTICLE_TYPE, FLD_ARTICLE_ID, FLD_PROVIDER, FLD_STOCK};
		String[] values = new String[]{order.getId(), article.getClass().getName(), article.getId(),
