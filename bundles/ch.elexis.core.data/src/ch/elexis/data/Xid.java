...
public class Xid extends PersistentObject implements IXid {
	 ...
	 * @param domain
	 *            the domain from wich the identifier is (e.g. DOMAIN_COVERCARD).
	 *            Must be a registered domain
	 * @param domain_id
	 *            the id from that domain that identifies the object
	 * @param quality
	 *            the quality of this identifier
	 * @throws XIDException
	 *             if a XID with same domain and domain_id but different object or
	 *             quality already exists. if the domain was not rgeistered
	 */
	 ...
	 * 
	 * @param domain
	 *            the domain to search an id from, Can be full name or local short
	 *            name of the domain
	 * @param id
