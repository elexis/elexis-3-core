...
public interface ModelFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Input Data Text</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Input Data Group Component</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return a new object of class '<em>Input Data Group Component</em>'.
	 * @generated
	 */
	InputDataGroupComponent createInputDataGroupComponent();

	/**
	 * Returns a new object of class '<em>Code Element</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Input Data Date</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
