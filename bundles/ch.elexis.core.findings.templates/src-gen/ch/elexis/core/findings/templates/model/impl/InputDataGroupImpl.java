 ...
 * Data Group</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link ch.elexis.core.findings.templates.model.impl.InputDataGroupImpl#getFindingsTemplates
 * <em>Findings Templates</em>}</li>
 * <li>{@link ch.elexis.core.findings.templates.model.impl.InputDataGroupImpl#getDataType
 * <em>Data Type</em>}</li>
 * </ul>
 *
 * @generated
...
public class InputDataGroupImpl extends MinimalEObjectImpl.Container implements InputDataGroup {
	 ...
	 * Templates</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	public EList<FindingsTemplate> getFindingsTemplates() {
		if (findingsTemplates == null) {
			findingsTemplates = new EObjectResolvingEList<FindingsTemplate>(FindingsTemplate.class, this,
					ModelPackage.INPUT_DATA_GROUP__FINDINGS_TEMPLATES);
		}
