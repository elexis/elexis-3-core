 ...
 * </p>
 * <ul>
 * <li>{@link ch.elexis.core.findings.templates.model.InputDataGroup#getFindingsTemplates
 * <em>Findings Templates</em>}</li>
 * <li>{@link ch.elexis.core.findings.templates.model.InputDataGroup#getDataType
 * <em>Data Type</em>}</li>
 * </ul>
 *
...
public interface InputDataGroup extends InputData {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Findings Templates</em>' reference list isn't
	 ...
	 * value is <code>"GROUP"</code>. The literals are from the enumeration
