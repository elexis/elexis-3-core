...
public class TableRECHNUNGEN extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[] { "ID", "lastupdate", "deleted", "RnNummer", "FallID", "MandantID", "RnDatum", "RnStatus",
				"RnDatumVon", "RnDatumBis", "Betrag", "StatusDatum", "ExtInfo" };
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[] { "varchar(25)", "bigint(20)", "char(1)", "varchar(8)", "varchar(25)", "varchar(25)",
	...
	protected String[] referentialIntegrityCheckSQLin186() {
		return new String[] { "FallID does not have an associated entry in FAELLE or is NULL",
