...
public class TableETIKETTEN_OBJECT_LINK extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[]{"lastupdate", "obj", "etikette"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"bigint(20)", "varchar(25)", "varchar(25)"};
	}
