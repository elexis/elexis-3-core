...
public class TableREMINDERS extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[] { "ID", "lastupdate", "deleted", "IdentID", "OriginID", "Responsible", "DateDue", "Status",
				"Typ", "Params", "Message" };
	}
	...
	protected String[] returnFieldTypesIn186() {
		return new String[] { "varchar(25)", "bigint(20)", "char(1)", "varchar(25)", "varchar(25)", "varchar(25)",
				"char(8)", "varchar(1)", "varchar(1)", "longtext", "longtext" };
	}
