...
public class TableEIGENLEISTUNGEN extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "Code", "Bezeichnung", "EK_PREIS", "VK_PREIS", "ZEIT"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(20)", "varchar(80)", "char(6)", "char(6)",
				"char(4)"};
	}
