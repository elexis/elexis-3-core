...
public class TableLEISTUNGSBLOCK extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "MandantID", "Name", "Leistungen"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(25)", "varchar(30)", "longblob"};
	}
	...
	protected String[] returnFieldsIn310() {
		return new String[]{"ID", "lastupdate", "deleted", "MandantID", "Name", "Leistungen", "Macro"};
	}
