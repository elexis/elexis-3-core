...
public class TableDBIMAGE extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[] { "ID", "lastupdate", "deleted", "Datum", "Prefix", "Title", "Bild" };
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[] { "varchar(25)", "bigint(20)", "char(1)", "char(8)", "varchar(80)", "varchar(80)",
				"longblob" };
	}
