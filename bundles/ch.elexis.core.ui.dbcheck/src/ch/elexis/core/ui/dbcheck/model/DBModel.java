...
public class DBModel {
	...
	public static String[] tablesInV186 = {"ARTIKEL", "ARTIKEL_DETAILS", "AUF", "BBS", "BEHANDLUNGEN", "BEHDL_DG_JOINT",
			"BRIEFE", "CONFIG", "DBIMAGE", "DIAGNOSEN", "EIGENLEISTUNGEN", "EK_PREISE", "HEAP", "KONTAKT", "KONTO",
			"LABORITEMS", "LABGROUPS", "LABORWERTE", "LEISTUNGEN", "LEISTUNGSBLOCK", "LOGS", "PATIENT_ARTIKEL_JOINT",
			"FAELLE", "ETIKETTEN", "ETIKETTEN_OBJCLASS_LINK", "KONTAKT_ADRESS_JOINT", "LABGROUP_ITEM_JOINT",
			"ETIKETTEN_OBJECT_LINK", "USERCONFIG", "HEAP2", "TRACES", "OUTPUT_LOG", "VK_PREISE", "RECHNUNGEN",
			"REMINDERS", "REMINDERS_RESPONSIBLE_LINK", "REZEPTE", "XID", "ZAHLUNGEN"};
	...
	public static TableDescriptor getTableDescription(String table) {
		try {
			Class<?> tableClass = Class.forName("ch.elexis.core.ui.dbcheck.model.Table" + table.toUpperCase());
