...
public abstract class ExternalMaintenance {
	 ...
	 *
	 * @param pm        the Progress Monitor, please provide the user some
	 *                  information about the happenings
	 * @param DBVersion the version string of the current database
	 * @return a String of the output you created, will be shown within the text
	 *         field
	 */
	public abstract String executeMaintenance(IProgressMonitor pm, String DBVersion);

	/**
	 * Label shown in the combo viewer; this describes the maintenance task to the
	 * user
	 *
