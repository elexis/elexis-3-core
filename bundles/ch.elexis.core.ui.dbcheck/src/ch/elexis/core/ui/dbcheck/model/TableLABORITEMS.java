...
public class TableLABORITEMS extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "kuerzel", "titel", "laborID", "RefMann", "RefFrauOrTx",
				"Einheit", "typ", "Gruppe", "prio", "billingcode"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(80)", "varchar(80)", "varchar(25)",
				"varchar(80)", "longtext", "varchar(20)", "char(1)", "varchar(25)", "char(3)", "varchar(20)"};
	}
	...
	protected String[] returnFieldTypesIn1810() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(80)", "varchar(80)", "varchar(25)",
				"varchar(256)", "varchar(256)", "varchar(20)", "char(1)", "varchar(25)", "char(3)", "varchar(20)",
				"varchar(100)"};
	}
	...
	protected String[] returnFieldsIn190() {
		return new String[]{"ID", "lastupdate", "deleted", "kuerzel", "titel", "laborID", "RefMann", "RefFrauOrTx",
				"Einheit", "typ", "Gruppe", "prio", "billingcode", "export", "loinccode", "visible", "digits",
				"formula"};
	}
	...
	protected String[] returnFieldTypesIn190() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(80)", "varchar(80)", "varchar(25)",
				"varchar(256)", "varchar(256)", "varchar(20)", "char(1)", "varchar(25)", "char(3)", "varchar(128)",
				"varchar(100)", "varchar(128)", "varchar(1)", "varchar(16)", "varchar(255)"};
	}
}
