...
public class TableZAHLUNGEN extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "RechnungsID", "Betrag", "Datum", "Bemerkung"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(25)", "char(8)", "char(8)", "varchar(80)"};
	}
