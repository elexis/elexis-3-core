...
public class TableFAELLE extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "PatientID", "GarantID", "KostentrID", "VersNummer",
				"FallNummer", "BetriebsNummer", "Diagnosen", "DatumVon", "DatumBis", "Bezeichnung", "Grund", "Gesetz",
				"Status", "ExtInfo"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(25)", "varchar(25)", "varchar(25)",
				"varchar(25)", "varchar(25)", "varchar(25)", "varchar(80)", "char(8)", "char(8)", "varchar(80)",
				"varchar(80)", "varchar(20)", "varchar(80)", "longblob"};
	}
	...
	protected String[] referentialIntegrityCheckSQLin186() {
		return new String[]{"PatientID does not have an associated entry in KONTAKTE or is NULL",
