...
public class TableREZEPTE extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "PatientID", "MandantID", "BriefID", "datum", "RpTxt",
				"RpZusatz"};
	}
	...
	protected String[] referentialIntegrityCheckSQLin186() {
		return new String[]{"PatientID does not have an associated entry in KONTAKT or is NULL",
