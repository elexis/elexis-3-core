...
public class TableKONTAKT_ADRESS_JOINT extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "myID", "otherID", "Bezug"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(25)", "varchar(25)", "varchar(30)"};
	}
	...
	protected String[] returnFieldsIn300() {
		return new String[]{"ID", "lastupdate", "deleted", "myID", "otherID", "Bezug", "myRType", "otherRType"};
	}
