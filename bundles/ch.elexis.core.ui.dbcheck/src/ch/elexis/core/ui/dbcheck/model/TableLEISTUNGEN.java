...
public class TableLEISTUNGEN extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "BEHANDLUNG", "LEISTG_TXT", "LEISTG_CODE", "KLASSE", "ZAHL",
				"EK_KOSTEN", "VK_TP", "VK_SCALE", "VK_PREIS", "SCALE", "SCALE2", "DETAIL"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(25)", "varchar(255)", "varchar(25)",
				"varchar(80)", "char(3)", "char(8)", "char(6)", "char(6)", "char(8)", "char(4)", "char(4)", "longblob"};
	}
	...
	protected String[] returnFieldTypesIn1813() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(25)", "varchar(255)", "varchar(25)",
				"varchar(80)", "char(3)", "char(8)", "char(8)", "char(8)", "char(8)", "char(4)", "char(4)", "longblob"};
	}

	@Override
	protected String[] returnFieldsIn1816() {
		return new String[]{"ID", "lastupdate", "deleted", "BEHANDLUNG", "LEISTG_TXT", "LEISTG_CODE", "KLASSE", "ZAHL",
				"EK_KOSTEN", "VK_TP", "VK_SCALE", "VK_PREIS", "SCALE", "SCALE2", "DETAIL", "userID"};
	}
