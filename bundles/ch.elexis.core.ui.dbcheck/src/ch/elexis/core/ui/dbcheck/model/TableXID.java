...
public class TableXID extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[] { "ID", "lastupdate", "deleted", "type", "object", "domain", "domain_id", "quality" };
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[] { "varchar(25)", "bigint(20)", "char(1)", "varchar(80)", "varchar(25)", "varchar(255)",
				"varchar(255)", "char(1)" };
	}
