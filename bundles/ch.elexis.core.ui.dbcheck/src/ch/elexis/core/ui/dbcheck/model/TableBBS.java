...
public class TableBBS extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "reference", "topic", "date", "time", "authorID", "message"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(25)", "bigint(20)", "char(1)", "varchar(25)", "varchar(80)", "char(8)", "char(4)",
				"varchar(25)", "longtext"};
	}
