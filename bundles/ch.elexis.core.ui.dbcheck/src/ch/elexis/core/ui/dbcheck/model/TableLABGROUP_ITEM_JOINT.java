...
public class TableLABGROUP_ITEM_JOINT extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[]{"lastupdate", "GroupID", "ItemID", "Comment"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"bigint(20)", "varchar(25)", "varchar(25)", "longtext"};
	}
