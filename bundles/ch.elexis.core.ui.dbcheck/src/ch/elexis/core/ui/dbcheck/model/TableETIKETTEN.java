...
public class TableETIKETTEN extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[] { "ID", "lastupdate", "Image", "deleted", "importance", "Name", "foreground", "background",
				"classes" };
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[] { "varchar(25)", "bigint(20)", "varchar(25)", "char(1)", "varchar(7)", "varchar(40)",
				"char(6)", "char(6)", "varchar(255)" };
	}
