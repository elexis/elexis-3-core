...
public class TableVK_PREISE extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[]{"TYP", "ID", "lastupdate", "DATUM_VON", "DATUM_BIS", "MULTIPLIKATOR"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(80)", "varchar(25)", "bigint(20)", "char(8)", "char(8)", "char(4)"};
	}
	...
	protected String[] returnFieldTypesIn1812() {
		return new String[]{"varchar(80)", "varchar(25)", "bigint(20)", "char(8)", "char(8)", "char(8)"};
	}
}
