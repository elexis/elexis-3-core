...
public class TablePATIENT_ARTIKEL_JOINT extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[] { "ID", "lastupdate", "deleted", "PatientID", "ArtikelID", "Artikel", "RezeptID",
	...
	protected String[] returnFieldsIn310() {
		return new String[] { "ID", "lastupdate", "deleted", "PatientID", "ArtikelID", "Artikel", "RezeptID",
				"DateFrom", "DateUntil", "Dosis", "Anzahl", "Bemerkung", "ExtInfo", "prescType", "sortOrder",
				"prescDate", "prescriptor" };
	}
