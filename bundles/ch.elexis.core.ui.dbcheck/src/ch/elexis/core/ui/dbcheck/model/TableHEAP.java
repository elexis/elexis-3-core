...
public class TableHEAP extends TableDescriptor {

	@Override
	protected String[] returnFieldsIn186() {
		return new String[]{"ID", "lastupdate", "deleted", "inhalt", "datum"};
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[]{"varchar(80)", "bigint(20)", "char(1)", "longblob", "char(8)"};
	}
