...
public class TableBRIEFE extends TableDescriptor {
	...
	protected String[] returnFieldsIn186() {
		return new String[] { "ID", "lastupdate", "deleted", "Betreff", "Datum", "modifiziert", "gedruckt", "geloescht",
				"AbsenderID", "DestID", "BehandlungsID", "PatientID", "Typ", "MimeType", "Path" };
	}

	@Override
	protected String[] returnFieldTypesIn186() {
		return new String[] { "varchar(25)", "bigint(20)", "char(1)", "varchar(80)", "char(8)", "char(8)", "char(8)",
				"char(2)", "varchar(25)", "varchar(25)", "varchar(25)", "varchar(25)", "varchar(30)", "varchar(80)",
				"longtext" };
	}
	...
	protected String[] referentialIntegrityCheckSQLin186() {
		return new String[] { "ID does not have an associated entry in HEAP and HEAP2 or is NULL",
