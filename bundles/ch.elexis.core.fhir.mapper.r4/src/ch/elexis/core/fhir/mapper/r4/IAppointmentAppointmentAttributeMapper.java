...
public class IAppointmentAppointmentAttributeMapper
		extends IdentifiableDomainResourceAttributeMapper<IAppointment, Appointment> {
	...
	@Override
	public void fullElexisToFhir(IAppointment localObject, Appointment appointment, SummaryEnum summaryEnum) {
...
//			}
	...
	@Override
	public void fullFhirToElexis(Appointment source, IAppointment target) {
