 ...
 */
public class IInvoiceInvoiceAttributeMapper extends IdentifiableDomainResourceAttributeMapper<IInvoice, Invoice> {

	public IInvoiceInvoiceAttributeMapper() {
		super(Invoice.class);
	}

	@Override
	public void fullElexisToFhir(IInvoice source, Invoice target, SummaryEnum summaryEnum) {
		...
		for (IBilled iBilled : billed) {
			target.addLineItem(toInvoiceLineItemComponent(iBilled, sumTotal));
		}
		// totalPriceComponent
		// totalNet
	...
	public InvoiceLineItemComponent toInvoiceLineItemComponent(IBilled iBilled, ch.rgw.tools.Money sum) {
...
//		}
	...
	@Override
	public void fullFhirToElexis(Invoice source, IInvoice target) {
