...
public class PatientDetailView extends ViewPart implements IUnlockable, IActivationListener {
	...
	public void createPartControl(Composite parent){
				...
				new ListDisplay<BezugsKontakt>(ecZA, SWT.NONE, new ListDisplay.LDListener() {
					...
					public void hyperlinkActivated(final String l){
						...
						KontaktSelektor ksl = new KontaktSelektor(
							PlatformUI.getWorkbench().getDisplay().getActiveShell(), Kontakt.class,
		...
		// zusatz adressen
		{
			ExpandableComposite compAdditionalAddresses = WidgetFactory.createExpandableComposite(
				toolkit, scrldfrm, Messages.Patientenblatt2_additionalAdresses);
		...
		// diagnosis
		{
			...
			sectDiagnosen.setExpanded(
				CoreHub.localCfg.get(KEY_PATIENTENBLATT + sectDiagnosen.getText(), false));
		...
		// personal anamnesis
		{
			...
			sectAnamnese.setExpanded(
				CoreHub.localCfg.get(KEY_PATIENTENBLATT + sectAnamnese.getText(), false));
		...
		// family anamnesis
		{
			...
			sectFamAnamnese.setExpanded(
				CoreHub.localCfg.get(KEY_PATIENTENBLATT + sectFamAnamnese.getText(), false));
		...
		// allergy
		{
			...
			sectAllergien.setExpanded(
				CoreHub.localCfg.get(KEY_PATIENTENBLATT + sectAllergien.getText(), false));
		...
		// risks
		{
			...
			sectRisiken.setExpanded(
				CoreHub.localCfg.get(KEY_PATIENTENBLATT + sectRisiken.getText(), false));
		...
		// remarks
		{
			...
			sectBemerkungen.setExpanded(
				CoreHub.localCfg.get(KEY_PATIENTENBLATT + sectBemerkungen.getText(), false));
	...
	private void makeAdditionalAddressActions(){
		...
		showAdditionalAddressAction = new Action(Messages.Patientenblatt2_showAddress) {
			...
			public void run(){
				...
				ZusatzAdresseEingabeDialog aed = new ZusatzAdresseEingabeDialog(scrldfrm.getShell(),
