...
public interface IContactGenoameService {
	...
	/**
	 * @return all available ZIP codes for the country; if the respective country is
	 *         not available, an empty {@link List} will be returned
	 */
	List<String> getZip();

	/**
	 * @return a list of values "city (main postal code)" , or an empty {@link List}
	 ...
	 * @return the cities registered for this zip code, or an empty {@link List} if
	 ...
	 * @return the ZIP codes registered for the city, or an empty {@link List} if
	 *         information is not available
	 */
	 ...
	 *
	 * @param zip the ZIP code of the city
	 * @return the streets registered, or an empty {@link List} if information is
	 *         not available
	 */
