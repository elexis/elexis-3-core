		...
		for (Control ctrl : controls) {
			if (ctrl instanceof LabeledInputField) {
				...
				if (field != null) {
					...
					if (ConfigServiceHolder.getUser(Preferences.USR_PATDETAIL_FIXEDWIDTH_STATE, false)) {
						fieldWidth += ConfigServiceHolder.getUser(Preferences.USR_PATDETAIL_FIXEDWIDTH, 0);
