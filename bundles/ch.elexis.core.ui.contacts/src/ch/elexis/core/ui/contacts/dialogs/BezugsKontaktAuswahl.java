...
public class BezugsKontaktAuswahl extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		if (bezugsKontakt != null && bezugsKontakt.exists()) {
			...
			mapBezugKonktatRelation.put(bezugsKontakt.getBezug(), new BezugsKontaktRelation(bezugsKontakt));
		}
	...
	public void reCalc(boolean autoSelect) {
		...
		if (selectedBezugKontaktRelation == null) {
			selectedBezugKontaktRelation = new BezugsKontaktRelation(cbBezugSrc.getText(), RelationshipType.AGENERIC,
		...
		if (autoSelect) {
			...
			cbTypeDest.setText(LocalizeUtil.getLocaleText(selectedBezugKontaktRelation.getDestRelationType()));
		}
	}
