...
public class IIdentifiableModifiableListComposite<T extends Identifiable> extends Composite {
	...
	public IIdentifiableModifiableListComposite(Composite parent, int style) {
		...
		btnRemove.addSelectionListener(new SelectionAdapter() {
			...
			@Override
			public void widgetSelected(SelectionEvent e) {
				IStructuredSelection structuredSelection = identifiableListViewer.getStructuredSelection();
	...
	/**
	 * Set a {@link Runnable} to be executed when the user selects the <i>Add
	 * Element</i>
	 * 
	 * @param runnable
	 */
	...
	/**
	 * Set a {@link Consumer} to be executed when the user selects <i>Delete
	 * Element</i>, will be called separately for each selected element
	 * 
	 * @param consumer
	 */
