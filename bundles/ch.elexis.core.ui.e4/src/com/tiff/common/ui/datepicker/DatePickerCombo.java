 ...
 *
 * changes by jense128 (Laurent Dutheil) * combo box is now smaller than the
 * calendar widget
 *
 * changes by gis (Carsten Pfeiffer) * fixed focus handling as described in bug
 * 1187304
 *
...
public class DatePickerCombo extends Composite {
	 ...
	 * control to hide it default is false meaning you have to double click a date
	 *
	 * @author sebthom
	 */
	...
	/**
	 * set if you need to double click a date in the expanded calender control to
	 * hide it default is false meaning you have to double click a date
	 *
	 * @author sebthom
