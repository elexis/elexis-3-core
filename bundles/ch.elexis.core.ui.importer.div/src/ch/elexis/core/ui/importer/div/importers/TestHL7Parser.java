...
public class TestHL7Parser extends HL7Parser {
	...
	public TestHL7Parser(String mylab) {
		super(mylab, new ImporterPatientResolver(), LabImportUtilHolder.get(), new OverwriteAllImportHandler(),
				new DefaultLabContactResolver(), CoreHub.localCfg.get(CFG_IMPORT_ENCDATA, false));
	}
