...
public class PersAnamnesisResolver extends AbstractTextResolver implements ITextResolver {
	...
	public Optional<String> resolve(Object object){
		if (object instanceof Patient) {
			if (ConfigServiceHolder.getGlobal(IMigratorService.PERSANAM_SETTINGS_USE_STRUCTURED, false)) {
				return getFindingsText(object, FindingsDataAccessor.FINDINGS_PATIENT_PERSANAM);
			}
		}
