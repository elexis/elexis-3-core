...
public class InstanceServiceV1Api extends BaseApi {
   ...
   */
  public void clearInstanceStatus() throws ApiException {
    this.clearInstanceStatus(Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public void clearInstanceStatus(Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/api/v1/services/instance/$clear";
