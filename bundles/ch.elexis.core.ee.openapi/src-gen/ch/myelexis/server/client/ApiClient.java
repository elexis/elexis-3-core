...
import ch.myelexis.server.client.auth.Authentication;
import ch.myelexis.server.client.auth.HttpBearerAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(CloseableHttpClient httpClient) {
    ...
    authentications.put("ElexisEnvironment", new HttpBearerAuth("bearer"));
