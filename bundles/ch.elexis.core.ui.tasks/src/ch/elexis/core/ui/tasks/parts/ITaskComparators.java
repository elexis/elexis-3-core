...
public class ITaskComparators {
	...
	public static Comparator<ITask> ofRunAt() {
		return Comparator.comparing(ITask::getRunAt, Comparator.nullsFirst(Comparator.naturalOrder()));
	}

	public static Comparator<ITask> ofTaskDescriptorId() {
		return Comparator.comparing((task) -> task.getTaskDescriptor().getId(), String.CASE_INSENSITIVE_ORDER);
	}

	public static Comparator<ITask> ofFinishedAt() {
		return Comparator.comparing(ITask::getFinishedAt, Comparator.nullsFirst(Comparator.naturalOrder()));
	}

	public static Comparator<ITask> ofRunner() {
		return Comparator.comparing(ITask::getRunner, Comparator.nullsFirst(Comparator.naturalOrder()));
	}
	...
	public static Comparator<ITask> ofState() {
		return Comparator.comparing((task) -> task.getState());
	}
}
