...
public interface ITaskResultDetailContributor {
	...
	/**
	 * add a detail dialog for the task that is based on the
	 * {@link IIdentifiedRunnable} advertised in {@link #getIdentifiedRunnableId()}
	 *
	 * @param parent
	 * @param task
	 * @param e4Services provided services (e.g. ECommandService via key
