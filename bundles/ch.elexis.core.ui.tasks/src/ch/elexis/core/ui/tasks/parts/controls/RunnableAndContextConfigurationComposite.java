		...
		if (selectedRunnable != null) {
			...
			for (String key : keySet) {
				...
				if (defaultValue instanceof Boolean) {
					RunContextCheckButtonWithDefaultValue btnValue = new RunContextCheckButtonWithDefaultValue(
							compAssisted, this, key, (Boolean) defaultValue, (Boolean) configuredValue);
