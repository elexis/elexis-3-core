...
public class ChEprValueSetsContribution implements IValueSetContribution {
	...
	private String[] names = {"EprAuthorRole", "EprDocumentAvailabilityStatus", "EprDocumentClassCode",
			"EprDocumentConfidentialityCode", "EprDocumentFormatCode", "EprDocumentLanguage", "EprDocumentMimeType",
			"EprDocumentPracticeSettingCode", "EprDocumentTypeCode", "EprGender", "EprHealthcareFacilityTypeCode",};
