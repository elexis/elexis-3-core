...
public class Concept implements ICoding {
	...
	public String getDisplay() {
		return designation != null ? designation.stream().filter(i -> isMatchingLanguage(i)).findFirst()
				.map(i -> i.displayName).orElse(null) : null;
	}
	...
	public String toString() {
		return "Concept [code=" + code + ", codeSystem=" + codeSystem + ", designation=" + designation + "]";
	}
