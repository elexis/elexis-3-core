...
/**
 * Tie interface, adapter and entity classes together. Needed to get the correct
 * adapter class, if the entity maps to multiple adapters.
 * 
 * @author thomas
 *
 */
public class MappingEntry {
	...
	public MappingEntry(Class<?> interfaceClass, Class<? extends AbstractIdModelAdapter<?>> adapterClass,
	...
	/**
	 * Add a {@link Predicate} that will be tested on load of a
	 * {@link AbstractIdModelAdapter}. See
	 ...
	 * {@link AbstractIdModelAdapter}. See
	 * {@link AbstractModelAdapterFactory#createAdapter(Class)}
	 * 
	 * @param consumer
	 * @return
	 */
	...
	/**
	 * Add a {@link Consumer} that will be applied on initializing a new
	 * {@link AbstractModelQuery}.
	 * 
	 * @param consumer
	 * @return
	 */
	...
	/**
	 * If a precondition is available, it is tested on the adapter. Else always
	 * true.
	 * 
	 * @param adapter
	 * @return
