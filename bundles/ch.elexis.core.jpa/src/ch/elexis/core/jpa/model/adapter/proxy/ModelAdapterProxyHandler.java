...
/**
 * {@link InvocationHandler} can be used to make a loaded {@link Identifiable} garbage collect able.
 * It will be reloaded and held be a {@link WeakReference} on invocation of a method.
 * 
 * @author thomas
 *
 */
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable{
		...
		if (target != null) {
			Map<String, Method> methods =
				classMethodMap != null ? classMethodMap.get(target.getClass()) : null;
			if (methods == null) {
