...
public class DisplayPanel extends Composite implements ActiveControlListener {
	 ...
	 *
	 * @param po a PersistentObject that must have all fields defined, that are
	 ...
	 *
	 * @param doSave if true: changed fields are written back to the database.
	 *               false: No weiting occurs
	 */
