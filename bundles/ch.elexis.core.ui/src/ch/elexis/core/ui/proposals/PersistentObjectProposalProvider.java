...
public class PersistentObjectProposalProvider<T extends PersistentObject> implements IContentProposalProvider {
	...
	/**
	 * The label to add on the content proposal. Normally not required to be
	 * overriden. One example, however, is {@link Mandant} as the real label is
	 * gathered using {@link Mandant#getMandantLabel()} here.
	 *
	 * @param a
	 * @return
	 */
