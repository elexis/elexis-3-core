...
public class TextTemplatePrintSettings {
	 ...
	 * @param mandant           logged in mandant
	 * @param alternatePrintCfg alternative config entry to check for printer (may
	 *                          be null)
	 * @param alternateTrayCfg  alternative config entry to check for printer tray
	 *                          (may be null)
