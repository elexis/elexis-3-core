...
public class TextTemplate {
	...
	public TextTemplate(String name, String description, String mimeType, String mandantId, String templateId,
			boolean exists, boolean systemTemplate, boolean askForAddress) {
		this.name = name;
	...
	private void addTemplateReference(Brief template, boolean systemTemplate) {
		...
		if (sticker != null && sticker.getLabel().equals(BriefConstants.DONT_ASK_FOR_ADDRESS_STICKER)) {
		...
		updateConfigTemplateBase();
		printer = CoreHub.localCfg.get(cfgTemplateBase + TextTemplatePrintSettings.TXT_TEMPLATE_PRINTER_SUFFIX, null);
		tray = CoreHub.localCfg.get(cfgTemplateBase + TextTemplatePrintSettings.TXT_TEMPLATE_TRAY_SUFFIX, null);
	}
	...
	private void removePrintSettings() {
		CoreHub.localCfg.remove(cfgTemplateBase + TextTemplatePrintSettings.TXT_TEMPLATE_PRINTER_SUFFIX);
		CoreHub.localCfg.remove(cfgTemplateBase + TextTemplatePrintSettings.TXT_TEMPLATE_TRAY_SUFFIX);
	...
	public void setPrinter(String printer) {
		...
		CoreHub.localCfg.set(cfgTemplateBase + TextTemplatePrintSettings.TXT_TEMPLATE_PRINTER_SUFFIX, printer);
		CoreHub.localCfg.flush();
	}
	...
	public void setTray(String tray) {
		this.tray = tray;
		CoreHub.localCfg.set(cfgTemplateBase + TextTemplatePrintSettings.TXT_TEMPLATE_TRAY_SUFFIX, tray);
		CoreHub.localCfg.flush();
	}
	...
	/**
	 * Find an existing template with matching name. If the mandantId is provided,
	 * and a template with matching mandantId is found it is preferred to templates
	 * without mandantId.
	 *
	 * @param name
	 * @param mandantId
