...
public interface IViewContribution extends IUnlockable {
	...
	/**
	 *
	 * @return the positioning order on the respective contribution position. Allows
	 *         to rank the inclusion of contributions according to the number.
	 *         Defaults to 0. May not be used.
	 */
	...
	/**
	 * Create the contributed {@link Composite} implementation on the parent. Always
	 * test {@link IViewContribution#isAvailable()} before initializing the
	 * composite. Tip: use
	 ...
	 *
	 * @param detailObject   the detail object selected
