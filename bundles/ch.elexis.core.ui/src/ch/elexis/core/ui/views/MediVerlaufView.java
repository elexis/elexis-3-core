...
public class MediVerlaufView extends ViewPart implements IActivationListener {
	...
	private static final String[] columns = { Messages.EditAUFDialog_from, Messages.Core_Date_Until,
			Messages.MediVerlaufView_medicament, Messages.ArticleDefaultSignatureComposite_dosage };
