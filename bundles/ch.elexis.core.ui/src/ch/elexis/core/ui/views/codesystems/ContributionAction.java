...
/**
 * An Action that encapsulates a command menu contribution. Is used by
 * {@link CodeSelectorFactory} to dynamically add contributions to popup
 * menus.<br/>
 * <br/>
 * Selection is added to the {@link IEclipseContext} of the application under
 * the name <i>commandId.selection</i>, and should be removed by the handler.
 *
 * @author thomas
 *
 */
public class ContributionAction extends Action {
	...
	/**
	 * Test if the contribution should be visible by testing
	 * {@link IHandler#isEnabled()}.
	 *
	 * @return
	 */
