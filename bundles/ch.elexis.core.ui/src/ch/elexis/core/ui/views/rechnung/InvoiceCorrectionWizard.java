...
public class InvoiceCorrectionWizard extends Wizard {
	...
	class Page1 extends WizardPage {
		...
		public void createControl(Composite parent) {
			...
			TableViewer viewer = new TableViewer(container,
					SWT.SINGLE | SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL | SWT.READ_ONLY);
	...
	class Page2 extends WizardPage {
		...
		public void createControl(Composite parent) {
			...
			viewer = CheckboxTableViewer.newCheckList(tableComp, SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL);
			viewer.getTable().setLinesVisible(true);
			viewer.getTable().setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
			viewer.setContentProvider(new ArrayContentProvider());
			viewer.setInput(invoiceCorrectionDTO.getHistory());
			...
			gd.heightHint = 100;
			txtOutput = new Text(container, SWT.MULTI | SWT.WRAP | SWT.BORDER | SWT.V_SCROLL | SWT.READ_ONLY);
		...
		public void updateProcess() {
			for (InvoiceHistoryEntryDTO invoiceHistoryEntryDTO : invoiceCorrectionDTO.getHistory()) {
