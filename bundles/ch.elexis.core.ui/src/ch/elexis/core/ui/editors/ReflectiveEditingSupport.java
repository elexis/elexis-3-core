...
public class ReflectiveEditingSupport extends EditingSupport {
	...
	public ReflectiveEditingSupport(TableViewer columnViewer, String field, ICellEditorValidator validator,
			boolean markValidationFailed) {
		super(columnViewer);
		this.field = field;
				...
				editor.addListener(new ICellEditorListener() {
					...
					public void editorValueChanged(boolean oldValidState, boolean newValidState) {
						if (newValidState) {
							...
							editor.getControl().setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_RED));
						}
					}
