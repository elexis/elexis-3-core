...
public class EigenleistungCodeSelectorFactory extends CodeSelectorFactory {
	...
	public ViewerConfigurer createViewerConfigurer(CommonViewer commonViewer) {
		...
		ViewerConfigurer vc = new ViewerConfigurer(new EigenleistungContentProvider(commonViewer, slp),
	...
	private class EigenleistungContentProvider extends CommonViewerContentProvider {
		...
		public EigenleistungContentProvider(CommonViewer commonViewer, ControlFieldProvider controlFieldProvider) {
			super(commonViewer);
		...
		protected IQuery<?> getBaseQuery() {
			IQuery<ICustomService> query = CoreModelServiceHolder.get().getQuery(ICustomService.class);
			return query;
		}
