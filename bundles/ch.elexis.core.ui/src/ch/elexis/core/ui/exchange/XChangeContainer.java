...
public class XChangeContainer {
	 ...
	 * 
	 * @param path
	 *            a string of the form /element1/element2/name will get all Elements
	 *            with "name" in the body of element2. If name is *, will retrieve
	 *            all Children of element2. Path must begin at root level.
