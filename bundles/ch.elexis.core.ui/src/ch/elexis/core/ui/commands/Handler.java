...
public class Handler {
	...
	/**
	 * Return the given single Parameter. This is to be called from within the
	 * execute method of the command
	 * 
	 * @param eev
	 *            the ExecutionEnvironment of the command
	 * @return the Object as given from the caller to execute(...) or null if no
	 *         such object was given
	 */
