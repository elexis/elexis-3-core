...
public class ErsterMandantDialog extends TitleAreaDialog {
	...
	String[] anreden = { Messages.ErsterMandantDialog_Herr, Messages.ErsterMandantDialog_Frau,
	...
	protected void okPressed() {
		...
		m.set(new String[] { Person.NAME, Person.FIRSTNAME, Person.TITLE, Person.SEX, Person.FLD_E_MAIL,
				Person.FLD_PHONE1, Person.FLD_FAX, Kontakt.FLD_STREET, Kontakt.FLD_ZIP, Kontakt.FLD_PLACE },
				tLastname.getText(), tFirstname.getText(), tTitle.getText(), g, email, tPhone.getText(), tFax.getText(),
				tStreet.getText(), tZip.getText(), tStreet.getText());
		super.okPressed();
	}
