...
public class ChangePasswordDialog extends TitleAreaDialog {
	...
	private class PasswordChangeListener extends KeyAdapter {
		...
		public void keyReleased(KeyEvent e) {
			Set<PasswordValidationResult> validateNewPass = PasswordValidator.validateNewPass(txtPassword1.getText(),
					txtPassword2.getText(), disallowedPasswords);
	...
	private void update() {
		okButton.setEnabled(rulesDisabled | passwordOk);
	}
