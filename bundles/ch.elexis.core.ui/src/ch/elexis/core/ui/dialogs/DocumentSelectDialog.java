...
public class DocumentSelectDialog extends TitleAreaDialog {
	 ...
	 *
	 * @param templateName the name of the document-template to be tested
	 ...
	 * The flag is saved as a sticker for the template-document.
	 *
	 * @param template the document-template to be tested
	 * @return true if we should not show the address selection dialog
	 *
	 * @author marlovitsh
	 */
	 ...
	 *
	 * @param template            the document-template to be tested
	 * @param dontAskForAddressee whether or not to ask for an addressee when
