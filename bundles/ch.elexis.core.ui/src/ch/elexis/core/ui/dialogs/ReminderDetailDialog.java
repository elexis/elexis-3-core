...
public class ReminderDetailDialog extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		txtDescription.setMessage(Messages.Core_Description);
	...
	private void initialize() {
		...
		if (reminder != null) {
			rvapc.setConfiguredVisibility(reminder.getVisibility(), reminder.isPatientRelated() && patient != null);
		} else {
			rvapc.setConfiguredVisibility(null, patient != null);
		}
		updateModelToTarget();
	...
	private void performOk() {
		...
		String[] fields = new String[] { Reminder.FLD_SUBJECT, Reminder.FLD_MESSAGE, Reminder.FLD_PRIORITY,
				Reminder.FLD_STATUS, Reminder.FLD_KONTAKT_ID, Reminder.FLD_VISIBILITY, Reminder.FLD_DUE,
				Reminder.FLD_ACTION_TYPE };
		reminder.set(fields, txtSubject.getText(), txtDescription.getText(), Integer.toString(priority.numericValue()),
				Integer.toString(processStatus.numericValue()), contactId, Integer.toString(visibility.numericValue()),
