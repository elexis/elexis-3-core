...
/**
 * {@link IPartListener2} implementation that refreshed the provided
 * {@link ViewPart} if a matching partVisble event is fired by the workbench.
 * Other {@link IPartListener2} methods than partVisble are not overridden by
 * default, and can be overridden by sub classes.
 *
 * @author thomas
 *
 */
