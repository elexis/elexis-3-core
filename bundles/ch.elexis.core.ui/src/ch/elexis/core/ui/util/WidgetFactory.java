...
/**
 * Helferklasse zur Erzeugung von SWT-Widgets selbständig oder innerhalb einer
 * org.eclipse.ui.forms Form. Die in der Form erstellten Elemente erhalten
 * automatisch das Eclipse-look&feel und fügen sich dadurch gut in Eclipse ein.
 * 
 * @author Gerry
 */
public class WidgetFactory {
	...
	public static ExpandableComposite createExpandableComposite(final FormToolkit t, final ScrolledForm f,
			String text) {
	 ...
	 * @param lis
	 *            HyperlinkListener oder (einfacher) HyperlinkAdapter, der die
	 ...
	 * return ret; } public static GridData getHorzFillGridData(){ return new
