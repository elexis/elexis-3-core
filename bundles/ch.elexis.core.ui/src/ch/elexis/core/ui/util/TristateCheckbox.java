...
public class TristateCheckbox extends Button {
	 ...
	 * @param style  the style of control to construct. You do not need to set
	 ...
	 * @param style      the style of control to construct. You do not need to set
	 *                   SWT.CHECK which is automatically set.
	 * @param falseFirst set how the states are cycling through. true if unchecked
	 *                   follows after undefined, false if checked follows after
	 *                   undefined.
	 * @author H. Marlovits
	 */
	 ...
	 *
	 * @param newState the new tristate selection state, one of
	 *                 TristateCheckbox.TristateValue (TRUE/FALSE/UNDEF)
	 * @author H. Marlovits
	 */
	 ...
	 *
	 * @param newState the new tristate selection as a String value as it is saved
	 *                 in the db, one of
	 *                 StringConstants.ONE/StringConstants.ZERO/StringConstants.EMPTY
	 * @author H. Marlovits
	 */
	...
	public class TristateSelectionListener implements SelectionListener {
		 ...
		 *
		 * @param falseFirst specifies the order of the states. if true then false
		 *                   follows after undef, if false then true follows after undef
		 * @author H. Marlovits
		 */
