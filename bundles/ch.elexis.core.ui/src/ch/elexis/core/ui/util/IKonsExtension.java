...
public interface IKonsExtension extends IExecutableExtension {
	 ...
	 *
	 * @param styleRange eine StyleRange zum beliebig bearbeiten. Kann NULL sein.
	 * @param provider   den Provider-String, den diese IKonsExtension dem
	 *                   Extension-Point angegeben hat
	 * @param id         die ID, die die IKonsExtension dieser Textstelle zugewiesen
	 *                   hat
