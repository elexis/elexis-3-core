...
public class DefaultControlFieldProvider implements ControlFieldProvider {
	...
	/**
	 * Default implementation of a ControlFieldProvider. Creates a composite with a
	 * text input field for each of the fiels passed to the constructor.
	 *
	 * Fires a ChangedEvent whenever at least tow chars are entered in one of the
	 * fields
	 *
	 * @viewer Composite, where the viewer should be placed
	 * @flds Array of fields to be placed. Each field is the name of a field,
	 *       optionally followed by '=' and the localized to be displayed name
	 */
	 ...
	 *
	 * @param flds
	 * @param redraw redraw the fields
	 * @since 3.1.0
	 */
	...
	/**
	 * Setze Feld welches den Fokus erhaelt (nach DB name). Ein ungueltiger Name
	 * wird ignoriert.
	 *
	...
	/**
	 * Reaktion auf Eingaben in die Filterfelder. Reagiert erst wenn mindestens zwei
	 * Zeichen eingegeben wurden oder das Feld geleert wurde.
	 */
	...
	/**
	 * Alle Eingabefelder löschen und einen "changeEvent" feuern". Aber nur, wenn
	 * die Felder nicht schon vorher leer waren.
	 */
	@Override
	...
	/**
	 * Set a value on the filters specific index. Does not call
	 * {@link #fireChangedEvent()}.
	 *
	 * @param index
	 * @param value
	 * @since 3.2
