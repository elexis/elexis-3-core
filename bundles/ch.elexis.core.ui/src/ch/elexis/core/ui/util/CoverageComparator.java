...
public class CoverageComparator implements Comparator<Object> {
	...
	public int compare(Object o1, Object o2) {
		...
		if (o1 instanceof ICoverage && o2 instanceof ICoverage) {
			...
			if (comp == 0) {
				String systemName1 = coverage1.getBillingSystem() != null
						? coverage1.getBillingSystem().getName()
						: null;
				String systemName2 = coverage2.getBillingSystem() != null
						? coverage2.getBillingSystem().getName()
						: null;
