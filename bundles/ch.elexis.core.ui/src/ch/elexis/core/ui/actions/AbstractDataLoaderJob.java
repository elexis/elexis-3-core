...
/**
 * BackgroundJob which loads data from the database in background. The
 * definition of the access to the data is left to tzzhe implementing class.
 *
 ...
 *
 * @deprecated Die Funktionalität der BackgroundJobs kann seit Eclipse 3.0 von
 *             Eclipse-Jobs und Joblisteners übernommen werden. Neuer Code
 *             sollte direkt mit Eclipse Jobs arbeiten.
 * @author Gerry
 *
 */
public abstract class AbstractDataLoaderJob extends BackgroundJob {
	 ...
	 *
	 * Ein Filterprovider ist eine Klasse, die bei Bedarf einen Filter auf den
	 * Dataloader anwenden kann, welcher die zu lesenden Datensätze limitiert.
	 *
	 * @author gerry
	 *
	 */
