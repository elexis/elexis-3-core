 ...
 *
 * The run() method of this class checks the required access rights and runs
 * doRun() if access is granted.
 *
 * Classes extending this class must implement the method doRun() instead of
 * run().
 *
 ...
 * because the action is disabled if the user has not the required rights. See
 * setEnabled())
 *
 */
abstract public class RestrictedAction extends Action {
	 ...
	 *
	 * Classes extending RestrictedAction must implement this method instead of
	 * run().
	 */
