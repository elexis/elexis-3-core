...
public abstract class PersistentObjectLoader implements ICommonViewerContentProvider, IWorker {
	...
	/**
	 * One or more of the ControlField's selectors habe been changed. We'll wait a
	 * moment for more changes before we launch the loader. Use this method also to
	 * force a restart of the loader programatically (values can be null)
	 *
	...
	/**
	 * a QueryFilter can modify the Query of this Loader. It will be called before
	 * each reload.
	 *
	 * @author Gerry
	 *
