...
public class GlobalEventDispatcher implements IPartListener2 {
	 ...
	 *
	 * @param l    the Activationlistener. If a listener is added twice, it will be
	 *             called twice.
	 ...
	 *
	 * @param l    The listener to remove. If no such listener was added, nothing
	 *             happens
	 * @param part the worbench part this listener was attached to. If no such par
