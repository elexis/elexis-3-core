...
/**
 * <b>Poor mans dependency injection.</b> This file allows for the injection of
 * an external configuration. There are certain parts in code which are
 * "hard-wired" for the application of certain tasks. These may however be
 * necessary to be overriden, if e.g. someone wants to select a specific output
 * plugin. <br>
 * <br>
 * If a certain code part is modified for external configuration it is marked
 * with<br>
 ...
 * <br>
 * If you want to apply this, create a fragment with ch.elexis as host, that has
 * the file ElexisConfigurationConstants.properties in its root, with the
 * respective configuration parameter. If no such configuration file is found,
 * Elexis simply sticks to its default behaviour!<br>
 *
 * <b>Why?</b> We need to find a separation for instantiation of country
