...
public class TextTemplateRequirement implements ITextTemplateRequirement {
	...
	public static final String TT_KG_COVER_SHEET_DESC = "Deckblatt für die KG mit den Informationen aus Patientendetails";
	...
	public static final String TT_PATIENT_LABEL_DESC = "Patientenetikette mit Adresse, Geschlecht und Pat.-ID";
	...
	public static final String TT_BILLING_LIST_DESC = "Vorlage für die Ausgabe einer Abrechnungsliste";
	...
	public static final String TT_INTAKE_LIST_DESC = "Einnahmeliste Medikamente für angewählten Patient";
	...
	public String[] getNamesOfRequiredTextTemplate() {
		return new String[] { TT_AUF_CERT, TT_KG_COVER_SHEET, TT_KG, TT_ADDRESS_LABEL, TT_PATIENT_LABEL,
				TT_PATIENT_LABEL_ORDER, TT_MEDI_LABEL, TT_LIST, TT_BILLING_LIST, TT_ORDER, TT_XRAY, TT_INTAKE_LIST,
				TT_PRESCRIPTION };
	}

	@Override
	public String[] getDescriptionsOfRequiredTextTemplate() {
		return new String[] { TT_AUF_CERT_DESC, TT_KG_COVER_SHEET_DESC, TT_KG_DESC, TT_ADDRESS_LABEL_DESC,
				TT_PATIENT_LABEL_DESC, TT_PATIENT_LABEL_ORDER_DESC, TT_MEDI_LABEL_DESC, TT_LIST_DESC,
				TT_BILLING_LIST_DESC, TT_ORDER_DESC, TT_XRAY_DESC, TT_INTAKE_LIST_DESC, TT_PRESCRIPTION_DESC };
	}
