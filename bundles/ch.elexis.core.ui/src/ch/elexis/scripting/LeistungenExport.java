...
public class LeistungenExport {
	...
	public String doExport(String from, String until, String toDir) {
		...
		try {
			...
			int kantonal = 18;
			int andere = 19;
			String[] cols = new String[]{"UUID", "PatientID", "FallID", "KonsID", "Datum", "Mandant", "CodesystemName",
					"CodesystemCode", "Code", "Text", "Kostentraeger", "TarmedAL", "TarmedTL", "Physio", "Labor",
					"Medikament", "Medical", "MiGEL", "Kantonal", "Andere"};
