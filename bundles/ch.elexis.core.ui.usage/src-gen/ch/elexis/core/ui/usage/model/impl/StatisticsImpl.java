...
public class StatisticsImpl extends MinimalEObjectImpl.Container implements Statistics {
	...
	public void setFrom(Date newFrom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.STATISTICS__FROM, oldFrom, from));
	}
	...
	public void setTo(Date newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.STATISTICS__TO, oldTo, to));
	}
