 ...
 * </p>
 * <ul>
 * <li>{@link ch.elexis.core.ui.usage.model.impl.EventStatisticImpl#getAction
 * <em>Action</em>}</li>
 * <li>{@link ch.elexis.core.ui.usage.model.impl.EventStatisticImpl#getValue
 * <em>Value</em>}</li>
 * <li>{@link ch.elexis.core.ui.usage.model.impl.EventStatisticImpl#getTime
 * <em>Time</em>}</li>
 * <li>{@link ch.elexis.core.ui.usage.model.impl.EventStatisticImpl#getActionType
 * <em>Action Type</em>}</li>
 * <li>{@link ch.elexis.core.ui.usage.model.impl.EventStatisticImpl#getMinDuration
 * <em>Min Duration</em>}</li>
 * <li>{@link ch.elexis.core.ui.usage.model.impl.EventStatisticImpl#getMaxDuration
 * <em>Max Duration</em>}</li>
 * <li>{@link ch.elexis.core.ui.usage.model.impl.EventStatisticImpl#getAvgDuration
 * <em>Avg Duration</em>}</li>
 * <li>{@link ch.elexis.core.ui.usage.model.impl.EventStatisticImpl#getLastStart
 * <em>Last Start</em>}</li>
 * </ul>
 *
 * @generated
...
public class EventStatisticImpl extends MinimalEObjectImpl.Container implements EventStatistic {
	...
	/**
	 * The default value of the '{@link #getMinDuration() <em>Min Duration</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMinDuration()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getMinDuration() <em>Min Duration</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMinDuration()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getMaxDuration() <em>Max Duration</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMaxDuration()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getMaxDuration() <em>Max Duration</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMaxDuration()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getAvgDuration() <em>Avg Duration</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getAvgDuration()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getAvgDuration() <em>Avg Duration</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getAvgDuration()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getLastStart() <em>Last Start</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLastStart()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getLastStart() <em>Last Start</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLastStart()
	 * @generated
	...
	public void setAction(String newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EVENT_STATISTIC__ACTION, oldAction,
					action));
	}
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EVENT_STATISTIC__VALUE, oldValue,
					value));
	}
	...
	public void setActionType(String newActionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EVENT_STATISTIC__ACTION_TYPE,
	...
	public void setMinDuration(int newMinDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EVENT_STATISTIC__MIN_DURATION,
	...
	public void setMaxDuration(int newMaxDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EVENT_STATISTIC__MAX_DURATION,
	...
	public void setAvgDuration(long newAvgDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EVENT_STATISTIC__AVG_DURATION,
					oldAvgDuration, avgDuration));
	}
	...
	public void setLastStart(long newLastStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EVENT_STATISTIC__LAST_START,
