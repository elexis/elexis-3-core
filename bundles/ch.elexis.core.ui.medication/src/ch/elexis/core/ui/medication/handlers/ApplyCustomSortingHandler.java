...
public class ApplyCustomSortingHandler extends AbstractHandler {
	public static final String CMD_ID = "ch.elexis.core.ui.medication.ApplyCustomSorting"; //$NON-NLS-1$
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		ViewerSortOrder sortOrder = ViewerSortOrder.getSortOrderPerValue(ViewerSortOrder.DEFAULT.ordinal());
		if (!useDefault) {
