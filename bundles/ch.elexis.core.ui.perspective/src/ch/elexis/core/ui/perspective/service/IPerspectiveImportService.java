...
public interface IPerspectiveImportService {
	...
	/**
	 * Creates a legacy perspective from a given {@link MPerspective} Returns a list
	 * of fastview view ids.
	 *
	 * @param path
	 * @param mPerspective
	 * @return
	...
	/**
	 * Loads a perspective from {@link InputStream}, the stream will be closed
	 * afterwards.
	 *
	 * @param f
	 * @return
	...
	/**
	 * Returns the position of the perspective inside the stack of opened
	 * perspectives.
	 *
	 * @param perspectiveId
	 * @return returns -1 if the perspective with the given id is not found, or the
	 *         perspective is not inside the stack.
	 */
