...
public class ClinicalImpression extends AbstractFindingModelAdapter<ch.elexis.core.jpa.entities.ClinicalImpression>
	...
	public void setEncounter(IEncounter encounter) {
		...
		if (resource.isPresent()) {
			org.hl7.fhir.r4.model.ClinicalImpression fhirClinicalImpression = (org.hl7.fhir.r4.model.ClinicalImpression) resource
					.get();
			fhirClinicalImpression.setEncounter(new Reference(new IdDt("Encounter", encounter.getId())));
			saveResource(resource.get());
		}
