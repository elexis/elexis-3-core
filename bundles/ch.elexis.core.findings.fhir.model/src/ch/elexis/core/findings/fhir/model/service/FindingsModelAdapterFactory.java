...
public class FindingsModelAdapterFactory extends AbstractModelAdapterFactory {
	...
	protected void initializeMappings() {
		addMapping(
				new MappingEntry(IAllergyIntolerance.class, ch.elexis.core.findings.fhir.model.AllergyIntolerance.class,
						ch.elexis.core.jpa.entities.AllergyIntolerance.class));
		addMapping(
				new MappingEntry(IClinicalImpression.class, ch.elexis.core.findings.fhir.model.ClinicalImpression.class,
						ch.elexis.core.jpa.entities.ClinicalImpression.class));
		addMapping(new MappingEntry(ICondition.class, ch.elexis.core.findings.fhir.model.Condition.class,
				ch.elexis.core.jpa.entities.Condition.class));
		addMapping(new MappingEntry(IEncounter.class, ch.elexis.core.findings.fhir.model.Encounter.class,
		...
		addMapping(new MappingEntry(ILocalCoding.class, ch.elexis.core.findings.fhir.model.LocalCoding.class,
				ch.elexis.core.jpa.entities.LocalCoding.class));
		addMapping(new MappingEntry(IObservation.class, ch.elexis.core.findings.fhir.model.Observation.class,
				ch.elexis.core.jpa.entities.Observation.class));
		addMapping(new MappingEntry(IObservationLink.class, ch.elexis.core.findings.fhir.model.ObservationLink.class,
				ch.elexis.core.jpa.entities.ObservationLink.class));
		addMapping(new MappingEntry(IProcedureRequest.class, ch.elexis.core.findings.fhir.model.ProcedureRequest.class,
				ch.elexis.core.jpa.entities.ProcedureRequest.class));
		addMapping(
				new MappingEntry(IDocumentReference.class, ch.elexis.core.findings.fhir.model.DocumentReference.class,
